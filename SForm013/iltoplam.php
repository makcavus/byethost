...
if($yilgelen==""){
  $nuf=@mysqli_query($dbh,"select distinct vyiladi,vayadi from veris where ilidi='$ilgelen'");
}elseif($ilgelen>0 and $yilgelen>0){
  $nuf=@mysqli_query($dbh,"select distinct vyiladi,vayadi from veris where ilidi='$ilgelen' and vyiladi='$yilgelen'");
}
...
if($yilgelen==""){
$resultvyil = @mysqli_query($dbh,"select * from veris where(ilidi='$ilgelen')") ;
}elseif($ilgelen>0 and $yilgelen>0){
  $resultvyil = @mysqli_query($dbh,"select * from veris where(ilidi='$ilgelen' and vyiladi='$yilgelen')") ;
}
