...
//echo $k;
/*$result=mysqli_query($dbh,"select ilidi,vocadi,vyiladi,vayadi from veris ORDER BY vocadi",$dbh);
...
//$pdf->Table('select * from veris order by vocadi');
...
$pdf->SetY(0);
$pdf->SetX(50);
$pdf->Cell(120,6,turkce('AŞI SONUÇLARI ÇİZELGESİ  (SURİYELİLER İÇİN FORM 013)'),0,0,'C',1);
