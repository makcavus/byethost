...
v176,
v177
from veris where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen')") ;
}else{
$resultvyil = @mysqli_query($dbh,"select 
sum(v1) as v1,
sum(v2) as v2, 
...
from veris where(ilidi='$ilgelen' and vyiladi='$yilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen')") ;
}
