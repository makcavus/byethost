...
if($yilgelen==""){
  $nuf = @mysqli_query($dbh,"select * from veris where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen')") ;
}elseif($ocgelen>0 and $yilgelen>0){  
$nuf = @mysqli_query($dbh,"select * from veris where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen')") ;
}
...
if($yilgelen==""){
  $resultvyil = @mysqli_query($dbh,"select * from veris where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen')") ;
}elseif($ocgelen>0 and $yilgelen>0){  
