...
$gebedevir = @mysql_query("select vocadi,sum(v2) as gsonucarti,sum(v3+v4) as gsonuceksi from verib where(ilidi='1' and ilceidi='1' and vyiladi<'2013') group by vocadi order by vocadi asc") ;
$basla=4;
...
//GEBE GEÇEN******************************************************************************************************************
//OCAK
/*$ocakGA = @mysql_query("select sum(v2) as ocaktopGA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='OCAK')") ;
...
//ÞUBAT
$subatGA = @mysql_query("select sum(v2) as subattopGA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='ÞUBAT')") ;
...
//MART
$martGA = @mysql_query("select sum(v2) as marttopGA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='MART')") ;
...
//NÝSAN
$nisanGA = @mysql_query("select sum(v2) as nisantopGA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='NÝSAN')") ;
...
//MAYIS
$mayisGA = @mysql_query("select sum(v2) as mayistopGA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='MAYIS')") ;
...
//HAZÝRAN
$haziranGA = @mysql_query("select sum(v2) as hazirantopGA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='HAZÝRAN')") ;
...
//TEMMUZ
$temmuzGA = @mysql_query("select sum(v2) as temmuztopGA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='TEMMUZ')") ;
...
//AÐUSTOS
$agustosGA = @mysql_query("select sum(v2) as agustostopGA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='AÐUSTOS')") ;
...
//EYLÜL
$eylulGA = @mysql_query("select sum(v2) as eylultopGA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='EYLÜL')") ;
...
//EKÝM
$ekimGA = @mysql_query("select sum(v2) as ekimtopGA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='EKÝM')") ;
...
//KASIM
$kasimGA = @mysql_query("select sum(v2) as kasimtopGA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='KASIM')") ;
...
//ARALIK
$aralikGA = @mysql_query("select sum(v2) as araliktopGA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='ARALIK')") ;
...
// GEBE ÇIKAN*****************************************************************************************************************
//OCAK
$ocakGE = @mysql_query("select sum(v3+v4) as ocaktopGE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='OCAK')") ;
...
//ÞUBAT
$subatGE = @mysql_query("select sum(v3+v4) as subattopGE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='ÞUBAT')") ;
...
//MART
$martGE = @mysql_query("select sum(v3+v4) as marttopGE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='MART')") ;
...
//NÝSAN
$nisanGE = @mysql_query("select sum(v3+v4) as nisantopGE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='NÝSAN')") ;
...
//MAYIS
$mayisGE = @mysql_query("select sum(v3+v4) as mayistopGE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='MAYIS')") ;
...
//HAZÝRAN
$haziranGE = @mysql_query("select sum(v3+v4) as hazirantopGE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='HAZÝRAN')") ;
...
//TEMMUZ
$temmuzGE = @mysql_query("select sum(v3+v4) as temmuztopGE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='TEMMUZ')") ;
...
//AÐUSTOS
$agustosGE = @mysql_query("select sum(v3+v4) as agustostopGE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='AÐUSTOS')") ;
...
//EYLÜL
$eylulGE = @mysql_query("select sum(v3+v4) as eylultopGE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='EYLÜL')") ;
...
//EKÝM
$ekimGE = @mysql_query("select sum(v3+v4) as ekimtopGE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='EKÝM')") ;
...
//KASIM
$kasimGE = @mysql_query("select sum(v3+v4) as kasimtopGE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='KASIM')") ;
...
//ARALIK
$aralikGE = @mysql_query("select sum(v3+v4) as araliktopGE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='ARALIK')") ;
...
$buayba = @mysql_query("select sum(v11) as buaybasonuc from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='$aygelen')") ;
...
$buaybe = @mysql_query("select sum(v12+v13) as buaybesonuc from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='$aygelen')") ;
...
//DEVÝR HESAPLAMALARI*************************************************************************************************************
$bebekarti = @mysql_query("select sum(v11) as bsonucarti from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi<'$yilgelen')") ;
...
//echo $Toplambarti;
$bebekeksi = @mysql_query("select sum(v12+v13) as bsonuceksi from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi<'$yilgelen')") ;
...
//GEBE GEÇEN******************************************************************************************************************
//OCAK
$ocakBA = @mysql_query("select sum(v11) as ocaktopBA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='OCAK')") ;
...
//ÞUBAT
$subatBA = @mysql_query("select sum(v11) as subattopBA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='ÞUBAT')") ;
...
//MART
$martBA = @mysql_query("select sum(v11) as marttopBA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='MART')") ;
...
//NÝSAN
$nisanBA = @mysql_query("select sum(v11) as nisantopBA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='NÝSAN')") ;
...
//MAYIS
$mayisBA = @mysql_query("select sum(v11) as mayistopBA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='MAYIS')") ;
...
//HAZÝRAN
$haziranBA = @mysql_query("select sum(v11) as hazirantopBA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='HAZÝRAN')") ;
...
//TEMMUZ
$temmuzBA = @mysql_query("select sum(v11) as temmuztopBA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='TEMMUZ')") ;
...
//AÐUSTOS
$agustosBA = @mysql_query("select sum(v11) as agustostopBA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='AÐUSTOS')") ;
...
//EYLÜL
$eylulBA = @mysql_query("select sum(v11) as eylultopBA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='EYLÜL')") ;
...
//EKÝM
$ekimBA = @mysql_query("select sum(v11) as ekimtopBA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='EKÝM')") ;
...
//KASIM
$kasimBA = @mysql_query("select sum(v11) as kasimtopBA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='KASIM')") ;
...
//ARALIK
$aralikBA = @mysql_query("select sum(v11) as araliktopBA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='ARALIK')") ;
...
// GEBE ÇIKAN*****************************************************************************************************************
//OCAK
$ocakBE = @mysql_query("select sum(v12+v13) as ocaktopBE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='OCAK')") ;
...
//ÞUBAT
$subatBE = @mysql_query("select sum(v12+v13) as subattopBE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='ÞUBAT')") ;
...
//MART
$martBE = @mysql_query("select sum(v12+v13) as marttopBE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='MART')") ;
...
//NÝSAN
$nisanBE = @mysql_query("select sum(v12+v13) as nisantopBE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='NÝSAN')") ;
...
//MAYIS
$mayisBE = @mysql_query("select sum(v12+v13) as mayistopBE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='MAYIS')") ;
...
//HAZÝRAN
$haziranBE = @mysql_query("select sum(v12+v13) as hazirantopBE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='HAZÝRAN')") ;
...
//TEMMUZ
$temmuzBE = @mysql_query("select sum(v12+v13) as temmuztopBE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='TEMMUZ')") ;
...
//AÐUSTOS
$agustosBE = @mysql_query("select sum(v12+v13) as agustostopBE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='AÐUSTOS')") ;
...
//EYLÜL
$eylulBE = @mysql_query("select sum(v12+v13) as eylultopBE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='EYLÜL')") ;
...
//EKÝM
$ekimBE = @mysql_query("select sum(v12+v13) as ekimtopBE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='EKÝM')") ;
...
//KASIM
$kasimBE = @mysql_query("select sum(v12+v13) as kasimtopBE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='KASIM')") ;
...
//ARALIK
$aralikBE = @mysql_query("select sum(v12+v13) as araliktopBE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='ARALIK')") ;
...
//LOHUSA KISMI****************************************************************************************************************** 
//ÝÇÝNDE BULUNULAN AY TOPLAMLARI
$buayla = @mysql_query("select sum(v20) as buaylasonuc from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='$aygelen')") ;
...
$buayle = @mysql_query("select sum(v21+v22) as buaylesonuc from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='$aygelen')") ;
...
//DEVÝR HESAPLAMALARI*************************************************************************************************************
$lohusaarti = @mysql_query("select sum(v20) as lsonucarti from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi<'$yilgelen')") ;
...
//echo $Toplamlarti;
$lohusaeksi = @mysql_query("select sum(v21+v22) as lsonuceksi from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi<'$yilgelen')") ;
...
//LOHUSALIÐA GEÇEN*************************************************************************************************************
//OCAK
$ocakLA = @mysql_query("select sum(v20) as ocaktopLA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='OCAK')") ;
...
//ÞUBAT
$subatLA = @mysql_query("select sum(v20) as subattopLA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='ÞUBAT')") ;
...
//MART
$martLA = @mysql_query("select sum(v20) as marttopLA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='MART')") ;
...
//NÝSAN
$nisanLA = @mysql_query("select sum(v20) as nisantopLA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='NÝSAN')") ;
...
//MAYIS
$mayisLA = @mysql_query("select sum(v20) as mayistopLA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='MAYIS')") ;
...
//HAZÝRAN
$haziranLA = @mysql_query("select sum(v20) as hazirantopLA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='HAZÝRAN')") ;
...
//TEMMUZ
$temmuzLA = @mysql_query("select sum(v20) as temmuztopLA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='TEMMUZ')") ;
...
//AÐUSTOS
$agustosLA = @mysql_query("select sum(v20) as agustostopLA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='AÐUSTOS')") ;
...
//EYLÜL
$eylulLA = @mysql_query("select sum(v20) as eylultopLA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='EYLÜL')") ;
...
//EKÝM
$ekimLA = @mysql_query("select sum(v20) as ekimtopLA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='EKÝM')") ;
...
//KASIM
$kasimLA = @mysql_query("select sum(v20) as kasimtopLA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='KASIM')") ;
...
//ARALIK
$aralikLA = @mysql_query("select sum(v20) as araliktopLA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='ARALIK')") ;
...
// LOHUSA ÇIKAN*****************************************************************************************************************
//OCAK
$ocakLE = @mysql_query("select sum(v21+v22) as ocaktopLE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='OCAK')") ;
...
//echo "Ocak: ".$ocaktotalGE.".......";
//ÞUBAT
$subatLE = @mysql_query("select sum(v21+v22) as subattopLE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='ÞUBAT')") ;
...
//MART
$martLE = @mysql_query("select sum(v21+v22) as marttopLE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='MART')") ;
...
//NÝSAN
$nisanLE = @mysql_query("select sum(v21+v22) as nisantopLE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='NÝSAN')") ;
...
//MAYIS
$mayisLE = @mysql_query("select sum(v21+v22) as mayistopLE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='MAYIS')") ;
...
//HAZÝRAN
$haziranLE = @mysql_query("select sum(v21+v22) as hazirantopLE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='HAZÝRAN')") ;
...
//TEMMUZ
$temmuzLE = @mysql_query("select sum(v21+v22) as temmuztopLE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='TEMMUZ')") ;
...
//AÐUSTOS
$agustosLE = @mysql_query("select sum(v21+v22) as agustostopLE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='AÐUSTOS')") ;
...
//EYLÜL
$eylulLE = @mysql_query("select sum(v21+v22) as eylultopLE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='EYLÜL')") ;
...
//EKÝM
$ekimLE = @mysql_query("select sum(v21+v22) as ekimtopLE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='EKÝM')") ;
...
//KASIM
$kasimLE = @mysql_query("select sum(v21+v22) as kasimtopLE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='KASIM')") ;
...
//ARALIK
$aralikLE = @mysql_query("select sum(v21+v22) as araliktopLE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='ARALIK')") ;
...
//ÇOCUK KISMI********************************************************************************************************************
//ÝÇÝNDE BULUNULAN AY TOPLAMLARI
$buayca = @mysql_query("select sum(v30) as buaycasonuc from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='$aygelen')") ;
...
$buayce = @mysql_query("select sum(v31+v32) as buaycesonuc from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='$aygelen')") ;
...
//DEVÝR HESAPLAMALARI*************************************************************************************************************
$cocukarti = @mysql_query("select sum(v30) as csonucarti from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi<'$yilgelen')") ;
...
//echo $Toplamcarti;
$cocukeksi = @mysql_query("select sum(v31+v32) as csonuceksi from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi<'$yilgelen')") ;
...
//ÇOCUK GEÇEN******************************************************************************************************************
//OCAK
$ocakCA = @mysql_query("select sum(v30) as ocaktopCA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='OCAK')") ;
...
//ÞUBAT
$subatCA = @mysql_query("select sum(v30) as subattopCA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='ÞUBAT')") ;
...
//MART
$martCA = @mysql_query("select sum(v30) as marttopCA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='MART')") ;
...
//NÝSAN
$nisanCA = @mysql_query("select sum(v30) as nisantopCA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='NÝSAN')") ;
...
//MAYIS
$mayisCA = @mysql_query("select sum(v30) as mayistopCA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='MAYIS')") ;
...
//HAZÝRAN
$haziranCA = @mysql_query("select sum(v30) as hazirantopCA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='HAZÝRAN')") ;
...
//TEMMUZ
$temmuzCA = @mysql_query("select sum(v30) as temmuztopCA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='TEMMUZ')") ;
...
//AÐUSTOS
$agustosCA = @mysql_query("select sum(v30) as agustostopCA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='AÐUSTOS')") ;
...
//EYLÜL
$eylulCA = @mysql_query("select sum(v30) as eylultopCA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='EYLÜL')") ;
...
//EKÝM
$ekimCA = @mysql_query("select sum(v30) as ekimtopCA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='EKÝM')") ;
...
//KASIM
$kasimCA = @mysql_query("select sum(v30) as kasimtopCA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='KASIM')") ;
...
//ARALIK
$aralikCA = @mysql_query("select sum(v30) as araliktopCA from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='ARALIK')") ;
...
// ÇOCUK ÇIKAN*****************************************************************************************************************
//OCAK
$ocakCE = @mysql_query("select sum(v31+v32) as ocaktopCE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='OCAK')") ;
...
//ÞUBAT
$subatCE = @mysql_query("select sum(v31+v32) as subattopCE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='ÞUBAT')") ;
...
//MART
$martCE = @mysql_query("select sum(v31+v32) as marttopCE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='MART')") ;
...
//NÝSAN
$nisanCE = @mysql_query("select sum(v31+v32) as nisantopCE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='NÝSAN')") ;
...
//MAYIS
$mayisCE = @mysql_query("select sum(v31+v32) as mayistopCE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='MAYIS')") ;
...
//HAZÝRAN
$haziranCE = @mysql_query("select sum(v31+v32) as hazirantopCE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='HAZÝRAN')") ;
...
//TEMMUZ
$temmuzCE = @mysql_query("select sum(v31+v32) as temmuztopCE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='TEMMUZ')") ;
...
//AÐUSTOS
$agustosCE = @mysql_query("select sum(v31+v32) as agustostopCE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='AÐUSTOS')") ;
...
//EYLÜL
$eylulCE = @mysql_query("select sum(v31+v32) as eylultopCE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='EYLÜL')") ;
...
//EKÝM
$ekimCE = @mysql_query("select sum(v31+v32) as ekimtopCE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='EKÝM')") ;
...
//KASIM
$kasimCE = @mysql_query("select sum(v31+v32) as kasimtopCE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='KASIM')") ;
...
//ARALIK
$aralikCE = @mysql_query("select sum(v31+v32) as araliktopCE from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='ARALIK')") ;
