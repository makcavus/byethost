...
$baslik=$_GET['ilceninadi'].' İLÇESİ '.$graphname.trsil(' EVLENENLERİN YAŞ ve CİNS GRUPLARINA GÖRE DAĞILIMI');
$baslikfont=3 ;
...
$Sutun = (630-($topm*3.2))/8;         // S�tunlarin cizilecegi alani 12 parcaya bol
...
//--- Aylari ve SUTUNLARI cizmeye basliyoruz --------------------------------
$Sutun1 = (630-($topm*3.2))/8;         // S�tunlarin cizilecegi alani 12 parcaya bol
...
//--- End of Gunleri ve SUTUNLARI cizmeye basliyoruz -------------------------
imagestring($image,50,370,498,"17-Alt",$kirmizi);
imagestring($image,50,370,432,"18-24",$kirmizi);
imagestring($image,50,370,366,"25-29",$kirmizi);
imagestring($image,50,370,300,"30-34",$kirmizi);
imagestring($image,50,370,234,"35-39",$kirmizi);
imagestring($image,50,370,168,"40-44",$kirmizi);
imagestring($image,50,370,100,"45-49",$kirmizi);
imagestring($image,50,370,32,"50-+",$kirmizi);
...
imagestring($image,5,60,600,trsil("$baslik"),$kirmizi);
