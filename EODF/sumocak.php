...
//IMPLANT
$imparti = @mysql_query("select sum(v32+v33) as xsonucarti from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi<'$yilgelen')") ;
...
//echo $Toplamcarti;
$impeksi = @mysql_query("select sum(v34+v35+v36) as xsonuceksi from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi<'$yilgelen')") ;
