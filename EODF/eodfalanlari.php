...
$frmbaslik="EVLİLİK ÖNCESİ DANIŞMANLIK FORMU";
$ililcebaslik="İLİN ADI:";
$ahekkodbaslik="SAĞLIK RAPORU DÜZENLEYEN KURULUŞUN ADI:";
$sagrapdonembaslik="SAĞLIK RAPORUNUN DÜZENLENDİĞİ DÖNEM:";
$ygdagilimbaslik="YAŞ GRUPLARINA GÖRE DAĞILIM";
$oddagilimbaslik="ÖĞRENİM DURUMUNA GÖRE DAĞILIM";
$danverkadin="DANIŞMANLIK VERİLEN KADIN SAYISI";
$sagrapverkadin="SAĞLIK RAPORU DÜZENLENEN KADIN SAYISI";
$danvererkek="DANIŞMANLIK VERİLEN ERKEK SAYISI";
$sagrapvererkek="SAĞLIK RAPORU DÜZENLENEN ERKEK SAYISI";
$onyedibaslik="17 ve altı";
$ellibaslik="50 ve Üzeri";
$oydbaslik="Okur Yazar Değil";
$ilkortabaslik="İlk - Orta";
$lisebaslik="Lise";
$yobaslik="Yüksekokul/ Üniversite";
$digerbaslik="Diğer Modern Yöntem (kadın kondomu,diafram, spermisit,jel, ovül vb.)";
$gebelikbaslik="Gebelik Sonlandırma Sayısı";
$dusukbaslik="Düşükten Sonra AP Yöntemi Başlayan Kişi Sayısı";
$dogumsonubaslik="Doğum Sonu 42.Güne Kadar AP Yöntemi Başlayan Kişi Sayısı";
$yenibaslik="Yeni Başlayan Kişi Sayısı";
$eskibaslik="Eski Kullanıcı Sayısı";
$cikarilanriabaslik="Çıkarılan RİA Sayısı";
$devirbaslik="Geçen Aydan Devreden";
$gelenbaslik="Ay İçinde Gelen / Alınan";
$digergelenbaslik="Diğer Gelen (Başka kurumdan gelen,kişilerin getirdiği vb.)";
$zayibaslik="Zayi,İmha";
$geribaslik="Geri Alınan";
$sonucbaslik="Sonuç Kontrol";
...
$geneltoplam="TOPLAMI";
$not1="* Form aylık olarak,sağlık raporu düzenleyen kurum ve kuruluş tarafından İSM'ye,TSM tarafından da İl Sağlık Müdürlüğüne gönderilecektir.";
$not2="* İl Sağlık Müdürlüğünce 3 ayda bir formun icmali alınarak HSGM Kadın ve Üreme Sağlığı Daire Başkanlığına bildirilecektir.";
$not3="* *Çiftler ilgili sütuna ayrı ayrı kaydedilecektir.";
$not4="* Yaş Gruplarına Göre Dağılım = Öğrenim Durumuna Göre Daağılım = Akrabalık Durumu = Toplam olmalıdır.";
