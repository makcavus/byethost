...
echo '<form action="ilcepdf.php" method="get" name="gor">' ;
...
$resultvyil = @mysql_query("select * from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi='$yilgelen')") ;
...
echo '<form action="nufpirilceyg.php" method="get" name="gor" target="hoppa" onSubmit="hoppa()">' ;
...
<input name="SUBMIT" type="SUBMIT"  style="color:#000000;font-weight:bold;background:#66FF00" onmouseover="this.style.color='orange'" onmouseout="this.style.color='black'" value="<?php echo trsuz($yasgrbaslik); ?>"/>
...
<th class="style6" width="50%" align="center" bordercolor="#FFCC00" bgcolor="blue"><font size="4" color="yellow"><?php echo trsuz($ilcegorbaslik); ?></font></th>

<th class="style6" width="12%"align="center" bordercolor="#FFCC00" bgcolor="#FFCC00">

<?php

echo '<form action="nufpirilceod.php" method="get" name="gor" target="hoppa" onSubmit="hoppa()">' ;
...
<input name="SUBMIT" type="SUBMIT"  style="color:#000000;font-weight:bold;background:#66FF00" onmouseover="this.style.color='orange'" onmouseout="this.style.color='black'" value="<?php echo trsuz($ogrdurbaslik); ?>"/>
...
echo '<form action="/excelmysql/cekusilcexls.php" method="get" name="gor">' ;
...
$ilceadi=@mysql_query("select * from ilce where(ilinad='$ilgelen' and ilceid='$ilcem')");
...
<tr>
    ...
    <th width="27%" align="center"bordercolor="#000000" bgcolor="white" class="style5"><? $top="İLÇE TOPLAMI"; echo '<font size="3" family="Arial"><label>'.trsuz($ilinadi).'-'.trsuz($ilceninadi).'-'.$yilgelen.' '.trsuz($top).'</label></font>' ; ?></th>
...
<table class="cizgi" border="0" bordercolor="#FFFFFF" align="center" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>	
    ...
    <th  width="4%" align="left" bordercolor="white" colspan="16"><? $top="İLÇE TOPLAMI";  echo '<font size="3" family="Arial">'.trsuz($top).'</font>' ;?></th>
  ...
  <tr>
    ...
    <th  width="4%"align="left" bordercolor="white" colspan="16"><? $toplam="YILI"; echo '<font size="3" family="Arial">'.$yilgelen.' '.trsuz($toplam).'</font>' ;?></th>
  ...
  <th  width="4%"align="center" class="style5" bgcolor="#CEF6EC"><?php echo $verim60; ?></th>
    ...
    <th  width="4%" align="center" bgcolor="white" colspan="25">&nbsp;</th>
      ...
      <tr>
        ...
        <th  width="4%"align="left" class="style5" bgcolor="#CEF6EC" colspan="8"><? echo trsuz($ahkodum).' '.trsuz($ahno) ;?></th>
