...
$pdf->MultiCell(80,6,trsuz('İLÇE TOPLAMI'),0,'L');
...
$pdf->SetFont('Arial','',9);
$pdf->Cell(50,6,trsuz('Saglık Personeli Yardımı Olmadan'),1,0,'B','L',1);
$pdf->SetFont('Arial','',10);
...
$pdf->SetY(156);
$pdf->SetX(105);
$pdf->Cell(65,6,trsuz('Doğum Agırlıgı 1500 gr.ın Altında Olan'),1,0,'L',1);
