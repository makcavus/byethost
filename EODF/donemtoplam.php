...
<tr>
    ...
    <th width="27%" align="center"bordercolor="#000000" bgcolor="white" class="style5"><? $top="İL TOPLAMI"; echo '<font size="3" family="Arial"><label>'.trsuz($kurum).' '.$yilgelen.'-'.trsuz($donemi).'</label></font>' ; ?></th>
