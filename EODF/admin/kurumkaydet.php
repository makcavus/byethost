...
$ilceok='Kurumu Kaydedildi...';
echo '<label><font style="color:blue">'.$kurumgelen.' '.$ilceok.'<a href="ilekle.php"  onclick="history.back();" onsubmit="javascript:reloadPage(this)">...Geri</a></font></th></table>';
}else{
echo '<br>';
echo '<table class="cizgi" border="2" align="center" cellpadding="0" cellspacing="0" width="76%">';
