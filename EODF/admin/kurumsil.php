...
$degkurumgelenx=toUpperCase($_GET['kurumgir']);
...
echo '<label><font style="color:Red">Kayıt Silindi...<a href="ilekle.php" onsubmit="javascript:reloadPage(this)">Geri</a></font></label>';
