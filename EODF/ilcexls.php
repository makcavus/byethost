...
from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen') group by vocadi order by vocadi asc") ;
$oncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vayadi='OCAK') group by vocadi order by vocadi asc") ;
}else{
$resultvyil = @mysql_query("select vocadi as vvv,
v1 as v1,
sum(v2) as v2, 
...
sum(v172) as v172,
v176 as v176
from verib where(ilidi='$ilgelen' and vyiladi='$yilgelen' and ilceidi='$ilcegelen') group by vocadi order by vocadi asc") ;
$oncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi='$yilgelen' and vayadi='$aygelen') group by vocadi order by vocadi asc") ;
}
$row = 2;
...
sum(v171) as v171,
sum(v172) as v172
from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen') order by vocadi asc") ;
$toncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vayadi='OCAK')") ;
}else{
$tresultvyil = @mysql_query("select 
sum(v1) as v1,
sum(v2) as v2, 
...
sum(v171) as v171,
sum(v172) as v172
from verib where(ilidi='$ilgelen' and vyiladi='$yilgelen' and ilceidi='$ilcegelen') order by vocadi asc") ;
$toncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi='$yilgelen' and vayadi='$aygelen')") ;
}
...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('C'.$row, $tadnks)
            ->setCellValue('D'.$row, $tkaybebek)
...
header('Content-Disposition: attachment;filename="Degerlendirme Raporu.xls"');
