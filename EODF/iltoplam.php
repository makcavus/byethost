...
<th class="style6" width="50%" align="center" bordercolor="#FFCC00" bgcolor="blue"><font size="4" color="yellow"><?php echo trsuz($ilgorbaslik); ?></font></th>
...
echo '<form action="/excelmysql/cekusilxls.php" method="get" name="gor">' ;
...
<tr>
    ...
    <th width="27%" align="center"bordercolor="#000000" bgcolor="white" class="style5"><? echo '<font size="3" family="Arial"><label>'.trsuz($ilinadi).'-'.$yilgelen.' '.trsuz($iltopbaslik).'</label></font>' ; ?></th>
...
<table class="cizgi" border="0" bordercolor="#FFFFFF" align="center" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
    ...
    <th  width="4%" align="left" bordercolor="white" colspan="16"><? echo '<font size="3" family="Arial">'.trsuz($ilinadi).'</font>' ;?></th>  
  ...
  <tr>	
    ...
    <th  width="4%" align="left" bordercolor="white" colspan="16"><? echo '<font size="3" family="Arial">'.trsuz($iltopbaslik).'</font>' ;?></th>
  ...
  <tr>
    ...
    <th  width="4%"align="left" bordercolor="white" colspan="16"><? $toplam="YILI"; echo '<font size="3" family="Arial">'.$yilgelen.' '.$toplam.'</font>' ;?></th>
