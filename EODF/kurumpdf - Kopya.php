...
echo $yilgelen ;
echo $aygelen ;*/
$resultvyil = @mysql_query("select * from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocak' and vyiladi='$yilgelen')") ;
...
$pdf->MultiCell(20,6,$verim12,1,'C');

$pdf->SetY(84);
$pdf->SetX(130);
$pdf->Cell(50,6,trsuz('Loğusa'),1,0,'B','L',1);
$pdf->MultiCell(20,6,$verim13,1,'C');
//labaratuvar
$pdf->SetY(90);
$pdf->SetX(15);
...
$pdf->MultiCell(20,6,$verim14,1,'C');

$pdf->SetY(102);
$pdf->SetX(15);
$pdf->Cell(10,6,trsuz('Sayı'),1,0,'C',1);
$pdf->Cell(10,6,$verim17,1,0,'C',1);
$pdf->Cell(10,6,$verim18,1,0,'C',1);
$pdf->Cell(10,6,$verim19,1,0,'C',1);
$pdf->Cell(15,6,$verim20,1,0,'C',1);
$pdf->Cell(20,6,$verim21,1,0,'C',1);
$pdf->Cell(20,6,$verim22,1,0,'C',1);
$pdf->Cell(10,6,$verim23,1,0,'C',1);
$pdf->SetY(96);
$pdf->SetX(130);
$pdf->Cell(50,6,trsuz('Çocuk'),1,0,'B','L',1);
$pdf->MultiCell(20,6,$verim15,1,'C');

$pdf->SetY(102);
$pdf->SetX(130);
$pdf->Cell(50,6,trsuz('15-49 Yaş Kadın'),1,0,'B','L',1);
$pdf->MultiCell(20,6,$verim16,1,'C');
//?L?MLER
$pdf->SetY(114);
$pdf->SetX(15);
...
$pdf->Cell(20,6,$devredengebe,1,0,'C',1);

$pdf->SetY(16);
$pdf->SetX(120);
$pdf->Cell(5,6,'a',1,0,'C',1);
$pdf->Cell(55,6,trsuz('Geçen Aydan Devreden'),1,0,'L',1);
$pdf->Cell(20,6,$devredenbebek,1,0,'C',1);
...
$pdf->Cell(5,6,'a',1,0,'C',1);
$pdf->Cell(55,6,trsuz('Geçen Aydan Devreden'),1,0,'L',1);
$pdf->Cell(20,6,$devredenlohusa,1,0,'C',1);

$pdf->SetY(92);
$pdf->SetX(120);
$pdf->Cell(5,6,'a',1,0,'C',1);
$pdf->Cell(55,6,trsuz('Geçen Aydan Devreden'),1,0,'L',1);
$pdf->Cell(20,6,$devredencocuk,1,0,'C',1);
