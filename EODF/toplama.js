...
function getocak(countryId,stateId) {		
 ...
 function topla1(){ 
		...
		var v11 = parseInt(document.getElementById("v11").value);
	    		   if(isNaN(v7) || isNaN(v8)|| isNaN(v9)|| isNaN(v10)|| isNaN(v11)){ alert("sayi girmelisiniz,bossa 0 giriniz!"); return false;} 
		      if (IS_GECKO) {  
			         XHRO = new XMLHttpRequest();
					     } else if(IS_IE) { 
						         XHRO = new ActiveXObject("Microsoft.XMLHTTP"); 
								    }else{ alert("browseriniz XMLHttpRequest yntemini desteklemiyor!"); return false; } 
      XHRO.open("GET","topla1.php?v7="+v7+"&v8="+v8+"&v9="+v9+"&v10="+v10+"&v11="+v11,true);
   XHRO.onreadystatechange = function(){ 
       if(XHRO.readyState == 4){
     if(XHRO.status == 200){  
  ...
  function topla2(){ 
		...
		var v44 = parseInt(document.getElementById("v44").value);
	    		   if(isNaN(v24) || isNaN(v26)|| isNaN(v28)|| isNaN(v30)|| isNaN(v32) || isNaN(v34)|| isNaN(v36)|| isNaN(v38)|| isNaN(v40)|| isNaN(v42)|| isNaN(v44)){ alert("sayi girmelisiniz,bossa 0 giriniz!"); return false;} 
		      if (IS_GECKO) {  
			         XHRO = new XMLHttpRequest();
					     } else if(IS_IE) { 
						         XHRO = new ActiveXObject("Microsoft.XMLHTTP"); 
								    }else{ alert("browseriniz XMLHttpRequest yntemini desteklemiyor!"); return false; } 
      XHRO.open("GET","topla2.php?v24="+v24+"&v26="+v26+"&v28="+v28+"&v30="+v30+"&v32="+v32+"&v34="+v34+"&v36="+v36+"&v38="+v38+"&v40="+v40+"&v42="+v42+"&v44="+v44,true);
   XHRO.onreadystatechange = function(){ 
       if(XHRO.readyState == 4){
     if(XHRO.status == 200){  
 ...
 function topla3(){ 
		...
		var v45 = parseInt(document.getElementById("v45").value);
	    		   if(isNaN(v25) || isNaN(v27)|| isNaN(v29)|| isNaN(v31)|| isNaN(v33) || isNaN(v35)|| isNaN(v37)|| isNaN(v39)|| isNaN(v41)|| isNaN(v43)|| isNaN(v45)){ alert("sayi girmelisiniz,bossa 0 giriniz!"); return false;} 
		      if (IS_GECKO) {  
			         XHRO = new XMLHttpRequest();
					     } else if(IS_IE) { 
						         XHRO = new ActiveXObject("Microsoft.XMLHTTP"); 
								    }else{ alert("browseriniz XMLHttpRequest yntemini desteklemiyor!"); return false; } 
      XHRO.open("GET","topla3.php?v25="+v25+"&v27="+v27+"&v29="+v29+"&v31="+v31+"&v33="+v33+"&v35="+v35+"&v37="+v37+"&v39="+v39+"&v41="+v41+"&v43="+v43+"&v45="+v45,true);
   XHRO.onreadystatechange = function(){ 
       if(XHRO.readyState == 4){
     if(XHRO.status == 200){  
  ...
  function topla10(){ 
		...
		var v15 = parseInt(document.getElementById("v15").value);
		   		   if(isNaN(v1) || isNaN(v2)|| isNaN(v3)|| isNaN(v4)|| isNaN(v5)|| isNaN(v6)|| isNaN(v7)|| isNaN(v8) || isNaN(v9)|| isNaN(v10)|| isNaN(v11)|| isNaN(v12)|| isNaN(v13)|| isNaN(v14)|| isNaN(v15)){ alert("sayi girmelisiniz,bossa 0 giriniz!"); return false;} 
      ...
      XHRO.open("GET","topla10.php?v1="+v1+"&v2="+v2+"&v3="+v3+"&v4="+v4+"&v5="+v5+"&v6="+v6+"&v7="+v7+"&v8="+v8,true);
   XHRO.onreadystatechange = function(){ 
       if(XHRO.readyState == 4){
     if(XHRO.status == 200){  
	      document.getElementById("dvks").value = XHRO.responseText;
     }else{  
	      alert("XHR : request status 200 degil! , bilinmeyen bir cisim!");    
     }   
	   }
 ...
 //var v29 = parseInt(document.getElementById("29").value);
		...
		var v29 = parseInt(document.getElementById("v29").value);
		var v30 = parseInt(document.getElementById("v30").value);
		   		   if(isNaN(v16) || isNaN(v17)|| isNaN(v18)|| isNaN(v19)|| isNaN(v20) || isNaN(v21)|| isNaN(v22)|| isNaN(v23)|| isNaN(v24) || isNaN(v25)|| isNaN(v26)|| isNaN(v27)|| isNaN(v28)|| isNaN(v29)|| isNaN(v30)){ alert("sayi girmelisiniz,bossa 0 giriniz!"); return false;} 
      ...
      XHRO.open("GET","topla11.php?v16="+v16+"&v17="+v17+"&v18="+v18+"&v19="+v19+"&v20="+v20+"&v21="+v21+"&v22="+v22+"&v23="+v23,true);
   XHRO.onreadystatechange = function(){ 
       if(XHRO.readyState == 4){
     if(XHRO.status == 200){  
	      document.getElementById("srdks").value = XHRO.responseText;
     }else{  
	      alert("XHR : request status 200 degil! , bilinmeyen bir cisim!");    
     }   
	   }
 ...
 //var v122 = parseInt(document.getElementById("v122").value);
		...
		var v44 = parseInt(document.getElementById("v44").value);
		var v45 = parseInt(document.getElementById("v45").value);
		   		   if(isNaN(v31) || isNaN(v32)|| isNaN(v33)|| isNaN(v34)|| isNaN(v35)|| isNaN(v36)|| isNaN(v37)|| isNaN(v38) || isNaN(v39)|| isNaN(v40)|| isNaN(v41)|| isNaN(v42)|| isNaN(v43)|| isNaN(v44)|| isNaN(v45)){ alert("sayi girmelisiniz,bossa 0 giriniz!"); return false;} 
      ...
      XHRO.open("GET","topla12.php?v31="+v31+"&v32="+v32+"&v33="+v33+"&v34="+v34+"&v35="+v35+"&v36="+v36+"&v37="+v37+"&v38="+v38,true);
   XHRO.onreadystatechange = function(){ 
       if(XHRO.readyState == 4){
     if(XHRO.status == 200){  
	      document.getElementById("dves").value = XHRO.responseText;
     }else{  
	      alert("XHR : request status 200 degil! , bilinmeyen bir cisim!");    
     }   
	   }
 ...
 //var v122 = parseInt(document.getElementById("v122").value);
		...
		var v59 = parseInt(document.getElementById("v59").value);
		var v60 = parseInt(document.getElementById("v60").value);
		   		   if(isNaN(v46) || isNaN(v47)|| isNaN(v48)|| isNaN(v49)|| isNaN(v50)|| isNaN(v51)|| isNaN(v52)|| isNaN(v53) || isNaN(v54)|| isNaN(v55)|| isNaN(v56)|| isNaN(v57)|| isNaN(v58)|| isNaN(v59)|| isNaN(v60)){ alert("sayi girmelisiniz,bossa 0 giriniz!"); return false;} 
				   //if(v12<v15+v17){ alert("Sarfedilen Bebek D-Vit ilk kez baslanan toplamindan az olamaz!"); return false;} 
      ...
      XHRO.open("GET","topla13.php?v46="+v46+"&v47="+v47+"&v48="+v48+"&v49="+v49+"&v50="+v50+"&v51="+v51+"&v52="+v52+"&v53="+v53,true);
   XHRO.onreadystatechange = function(){ 
       if(XHRO.readyState == 4){
     if(XHRO.status == 200){  
	      document.getElementById("srdes").value = XHRO.responseText;
     }else{  
	      alert("XHR : request status 200 degil! , bilinmeyen bir cisim!");    
     }   
	   }
 ...
 //var v122 = parseInt(document.getElementById("v122").value);
  ...
  if(v1+v2+v3+v4+v5+v6+v7+v8!=v9+v10+v11+v12+v13 || v1+v2+v3+v4+v5+v6+v7+v8!=v14+v15 || v9+v10+v11+v12+v13!=v14+v15){ alert("Yas Grubu,Ogrenim Durumu ile Akrabalik Durumu esit olmalidir!"); return false;}
...
function esitmisrdks(){
		...
		var v29 = parseInt(document.getElementById("v29").value);
		var v30 = parseInt(document.getElementById("v30").value);
	if(v16+v17+v18+v19+v20+v21+v22+v23!=v24+v25+v26+v27+v28 || v16+v17+v18+v19+v20+v21+v22+v23!=v29+v30 || v24+v25+v26+v27+v28!=v29+v30) { alert("Yas Grubu,Ogrenim Durumu ile Akrabalik Durumu esit olmalidir!");return false;}	
  }
  function esitmidves(){
		var v31 = parseInt(document.getElementById("v31").value);
        var v32 = parseInt(document.getElementById("v32").value);
		...
		var v44 = parseInt(document.getElementById("v44").value);
		var v45 = parseInt(document.getElementById("v45").value);
	if(v31+v32+v33+v34+v35+v36+v37+v38!=v39+v40+v41+v42+v43 || v31+v32+v33+v34+v35+v36+v37+v38!=v44+v45 || v39+v40+v41+v42+v43!=v44+v45) { alert("Yas Grubu,Ogrenim Durumu ile Akrabalik Durumu esit olmalidir!");return false;}	
  }
  
function esitmisrdes(){
		var v46 = parseInt(document.getElementById("v46").value);
        var v47 = parseInt(document.getElementById("v47").value);
	    var v48 = parseInt(document.getElementById("v48").value); 
		var v49 = parseInt(document.getElementById("v49").value);
		...
		var v59 = parseInt(document.getElementById("v59").value);
		var v60 = parseInt(document.getElementById("v60").value);
	if(v46+v47+v48+v49+v50+v51+v52+v53!=v54+v55+v56+v57+v58 || v46+v47+v48+v49+v50+v51+v52+v53!=v59+v60 || v54+v55+v56+v57+v58!=v59+v60) { alert("Yas Grubu,Ogrenim Durumu ile Akrabalik Durumu esit olmalidir!");return false;}	
  }  
 //Kayit Kontrol yapma
