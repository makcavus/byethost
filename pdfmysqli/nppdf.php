...
$pdf->SetY(0);
$pdf->SetX(50);
$pdf->Cell(120,6,'DEMOGRAFİK VERİLER',0,0,'C',1);

$pdf->SetY(6);
$pdf->SetX(15);
$pdf->Cell(35,6,'İL:',0,0,'L',1);
...
$pdf->SetY(20);
$pdf->SetX(15);
$pdf->Cell(185,6,'NÜFUSUN YAŞ VE CİNS GRUPLARINA GÖRE DAĞILIMI',1,0,'C',1);


$pdf->SetY(26);
$pdf->SetX(15);
$pdf->Cell(47,6,'YAŞ GRUPLARI',1,0,'C','L',1);
...
$pdf->SetY(32);
$pdf->SetX(15);
$pdf->Cell(47,6,'0-4 YAŞ',1,0,'C','L',1);
...
$pdf->SetY(38);
$pdf->SetX(15);
$pdf->Cell(47,6,'5-9 YAŞ',1,0,'C','L',1);
...
$pdf->SetY(44);
$pdf->SetX(15);
$pdf->Cell(47,6,'10-14 YAŞ',1,0,'C','L',1);
...
$pdf->SetY(50);
$pdf->SetX(15);
$pdf->Cell(47,6,'15-19 YAŞ',1,0,'C','L',1);
...
$pdf->SetY(56);
$pdf->SetX(15);
$pdf->Cell(47,6,'20-24 YAŞ',1,0,'C','L',1);
...
$pdf->SetY(62);
$pdf->SetX(15);
$pdf->Cell(47,6,'25-29 YAŞ',1,0,'C','L',1);
...
$pdf->SetY(68);
$pdf->SetX(15);
$pdf->Cell(47,6,'30-34 YAŞ',1,0,'C','L',1);
...
$pdf->SetY(74);
$pdf->SetX(15);
$pdf->Cell(47,6,'35-39 YAŞ',1,0,'C','L',1);
...
$pdf->SetY(80);
$pdf->SetX(15);
$pdf->Cell(47,6,'40-44 YAŞ',1,0,'C','L',1);
...
$pdf->SetY(86);
$pdf->SetX(15);
$pdf->Cell(47,6,'45-49 YAŞ',1,0,'C','L',1);
...
$pdf->SetY(92);
$pdf->SetX(15);
$pdf->Cell(47,6,'50-54 YAŞ',1,0,'C','L',1);
...
$pdf->SetY(98);
$pdf->SetX(15);
$pdf->Cell(47,6,'55-59 YAŞ',1,0,'C','L',1);
...
$pdf->SetY(104);
$pdf->SetX(15);
$pdf->Cell(47,6,'60-64 YAŞ',1,0,'C','L',1);
...
$pdf->SetY(110);
$pdf->SetX(15);
$pdf->Cell(47,6,'65-69 YAŞ',1,0,'C','L',1);
...
$pdf->SetY(116);
$pdf->SetX(15);
$pdf->Cell(47,6,'70-74 YAŞ',1,0,'C','L',1);
...
$pdf->SetY(122);
$pdf->SetX(15);
$pdf->Cell(47,6,'75-79 YAŞ',1,0,'C','L',1);
...
$pdf->SetY(128);
$pdf->SetX(15);
$pdf->Cell(47,6,'80-84 YAŞ',1,0,'C','L',1);
...
$pdf->SetY(134);
$pdf->SetX(15);
$pdf->Cell(47,6,'85- + YAŞ',1,0,'C','L',1);
...
$pdf->SetY(149);
$pdf->SetX(15);
$pdf->Cell(185,6,'NÜFUSUN MEDENİ HALİNE GÖRE DAĞILIMI',1,0,'C',1);


$pdf->SetY(155);
$pdf->SetX(15);
$pdf->Cell(47,6,'MEDENİ HALİ',1,0,'C','L',1);
$pdf->Cell(46,6,'KADIN',1,0,'C',1);
$pdf->Cell(46,6,'ERKEK',1,0,'C',1);
$pdf->Cell(46,6,'TOPLAM',1,0,'C',1);
//$pdf->RotatedText(91,36,trsuz('1 yaş'),0);
...
$pdf->SetY(179);
$pdf->SetX(15);
$pdf->Cell(47,6,'BOŞANMIŞ',1,0,'C','L',1);
...
$pdf->SetY(185);
$pdf->SetX(15);
$pdf->Cell(47,6,'EŞİ ÖLMÜŞ',1,0,'C','L',1);
...
$pdf->SetY(200);
$pdf->SetX(15);
$pdf->Cell(185,6,'NÜFUSUN ÖĞRENİM DURUMUNA GÖRE DAĞILIMI',1,0,'C',1);


$pdf->SetY(206);
$pdf->SetX(15);
$pdf->Cell(47,6,'ÖĞRENİM DURUMU',1,0,'C','L',1);
$pdf->Cell(46,6,'KADIN',1,0,'C',1);
$pdf->Cell(46,6,'ERKEK',1,0,'C',1);
$pdf->Cell(46,6,'TOPLAM',1,0,'C',1);
//$pdf->RotatedText(91,36,trsuz('1 yaş'),0);
...
$pdf->SetY(212);
$pdf->SetX(15);
$pdf->Cell(47,6,'OKUL ÇAĞINDA DEĞİL',1,0,'C','L',1);
...
$pdf->SetY(218);
$pdf->SetX(15);
$pdf->Cell(47,6,'OKUR YAZAR DEĞİL',1,0,'C','L',1);
...
$pdf->SetY(230);
$pdf->SetX(15);
$pdf->Cell(47,6,'İLKOKUL',1,0,'C','L',1);
...
$pdf->SetY(248);
$pdf->SetX(15);
$pdf->Cell(47,6,'YÜKSEKOKUL',1,0,'C','L',1);
...
$pdf->SetY(264);
$pdf->SetX(15);
$pdf->Cell(50,4,'Formu Düzenleyen',0,0,'C',1);
$pdf->SetY(264);
$pdf->SetX(135);
...
$pdf->Cell(50,4,$verim173,0,0,'C',1);

$pdf->SetY(268);
$pdf->SetX(135);
//$pdf->Cell(30,4,trsuz('Adı Soyadı:'),1,0,'R',1);
$pdf->Cell(50,4,$verim176,0,0,'C',1);

$pdf->SetY(272);
$pdf->SetX(15);
//$pdf->Cell(30,4,trsuz('Ünvanı:'),1,0,'R',1);
$pdf->Cell(50,4,$verim174,0,0,'C',1);

$pdf->SetY(272);
$pdf->SetX(135);
//$pdf->Cell(30,4,trsuz('Ünvanı:'),1,0,'R',1);
$pdf->Cell(50,4,$verim177,0,0,'C',1);
/*
$pdf->SetY(274);
$pdf->SetX(15);
