...
$section->addText($ilinadi.'-'.$ilceninadi.' '.$socadi.' '.$noktatarih.' '.$hastaliste,$bilgi,$noSpace);
...
//$section->addText('');
$section->addText($not.' '.$socadi.' '.$icin,$bilgi,$noSpace, $hiza);
$section->addText($ilceninadi.' '.$socadi.''.$nden.' '.$noktatarih.' '.$hastbildirilen,$soru, $hiza, $noSpace);
...
//$section->addText('');
$section->addText($socadi.''.$ne.' '.$basvuran.' '.$ektoplam.' '.$hastadan.' '.$verim40 ,$bilgi,$noSpace);
