...
echo'<meta http-equiv=refresh content="10; url=http://'.$siteadresi.'/byethost/c3c4/frm023kayit.php" /><a href="http://'.$siteadresi.'/byethost/c3c4/frm023kayit.php" _fcksavedurl="http://'.$siteadresi.'/byethost/c3c4/frm023kayit.php">Tekrar deneyiniz.</a>';
echo mysqli_error();
 }
@mysqli_close($dbhabe);
 ?>