...
<th class="style6" width="50%" align="center" bordercolor="white" bgcolor="blue"><font size="4" color="yellow"><?php echo trsuz($kurumkaydeg) ; ?></font></th>
...
<input type="hidden" name="kurumgirgelen" id="kurumgirgelen" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="<? echo trsuz($kurumadi) ;?>" />

          <th ><?php echo trsuz($kurumadibaslik) ; ?></th>
          <th>
            <input id="kurumgir" name="kurumgirdeg" class="style1"  type="text" value="<?php echo trsuz($kurumadi) ; ?>">
          </th>

 <th><?php echo trsuz($asmadibaslik) ; ?></th>
            <th><input id="asmgir" name="asmgir" class="style1"  type="text" value="<?php echo ucwords_tr($asmadi) ; ?>">
          </th>  
		  <th ><?php echo trsuz($ahekadibaslik) ; ?></th> 
		  <th>
            <input id="tbbgir" name="tbbgir" class="style1"  type="text" value="<?php echo trsuz($tbbadi) ; ?>">
          </th> 
</tr>
<tr>
<th ><?php echo trsuz($aseadibaslik) ; ?></th>		  
		 <th>
            <input id="asegir" name="asegir" class="style1"  type="text" value="<?php echo trsuz($aseadi) ; ?>">
          </th>
		  <th ><?php echo trsuz($aseünvanibaslik) ; ?></th>
		 <th>
            <input id="aseungir" name="aseungir" class="style1"  type="text" value="<?php echo trsuz($aseunv) ; ?>">
          </th>   
		  </tr>    
   </table> 
</form></div>
