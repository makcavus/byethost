...
$kucukharf=trsuz('ğüşıiöç');
$buyukharf=trsuz('ĞÜŞIİÖÇ');
...
echo '<label><font style="color:blue">'.trsuz($ilgelen).' '.trsuz($ilok).'<a href="ilekle.php" onsubmit="javascript:reloadPage(this)">'.trsuz($geridon).'</a></font></th></table>';
}else{
echo '<br>';
echo '<table class="cizgi" border="2" align="center" cellpadding="0" cellspacing="0" width="76%">';
...
echo '</tr>';
echo '<th bordercolor="white" bgcolor="yellow" bgcolor="yellow">';
echo '<label><font style="color:Red">'.trsuz($ilkaydolmadi).'</font></th></table>';
}
}
