...
$resultkurum = @mysql_query("select * from ocak where(socad='$uyekodu')");
...
<div id="drdiv"><form name="girdiekle" action="javascript:void(0)" method="get">
  ...
  <th class="style5" width="30%"align="left" bordercolor="white" bgcolor="#FFCC00" colspan="3"><a href=# onclick="kontroluye();"><img src="../images/iptal.png" /></a></th>
      ...
      <th class="style5" width="40%" align="center" bordercolor="white" bgcolor="blue" colspan="3"><font size="4" color="yellow"><?php echo trsuz($yenikulekleme) ; ?></font></th>

    <th class="style5" width="30%" align="right" bordercolor="yellow" bgcolor="#FFCC00" colspan="3"><a href="#" tabindex="1" title="hayir" onclick="uyeekle();"><img src="../images/kaydet.png" /></a></th>
...
<label class="style3" ><?php echo trsuz($dradi) ; ?></label></th>

<th bordercolor="white" bgcolor="yellow" align="left"><input type="text" name="doktoradi" id="doktoradi" value="<?php echo trsuz($tbbadi); ?>"/></th>

<th bordercolor="white" bgcolor="yellow" align="left"> 

<label class="style3" ><?php echo trsuz($kuladi) ; ?></label></th>
...
<label class="style3" ><?php echo trsuz($kulsifre) ; ?></label></th>
