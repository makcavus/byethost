...
$degkurumgelenx=iconv("utf-8","iso-8859-9",$_GET['kurumgir']);

$degkurumgelen=toUpperCase($degkurumgelenx);
...
echo '<label><font style="color:Red">'.trsuz($silindi).'<a href="ilekle.php"  onclick="history.back();" onsubmit="javascript:reloadPage(this)">'.trsuz($geridon).'</a></font></label>';
