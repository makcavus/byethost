...
<th class="style6" width="50%" align="center" bordercolor="white" bgcolor="blue"><font size="4" color="yellow"><?php echo trsuz($ilcekaydeg); ?></font></th>
...
<input type="hidden" name="selectilno" id="selectilno" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="<? echo trsuz($ilnom) ;?>" />
<input type="hidden" name="ilcegirgelen" id="ilcegirgelen" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="<? echo trsuz($ilceadi) ;?>" />

          <th ><?php echo trsuz($degilceismi); ?></th>
          <th>
            <input id="ilcegir" name="ilcegir" class="style1"  type="text" value="<?php echo trsuz($ilceadi) ; ?>">
          </th>
