...
echo '<label><font style="color:blue">'.trsuz($uyekodu).' '.trsuz($kulonceki).' '.trsuz($sonraki).'<a href="ilekle.php"  onclick="history.back();" onsubmit="javascript:reloadPage(this)">'.trsuz($geridon).'</a></font></label></th></table>';
}else{
echo '<br>';
echo '<table class="cizgi" border="2" align="center" cellpadding="0" cellspacing="0" width="76%">';
...
echo '</tr>';
echo '<th bordercolor="white" bgcolor="yellow" bgcolor="yellow">';
echo '<label><font style="color:Red">'.trsuz($kulolmadi).'</label><a href=# onClick="kontrolkurum();"><img src="images/iptal.png"></a></th></table>';
echo mysql_error();
 }
