...
<th bordercolor="white" bgcolor="yellow" colspan="4" align="right"><a href="duyurukayit.php" target="sag" ><img src="images/Resim7.png" width="180" height="30" onmousemove="this.src='images/Resim8.png'" onmouseout="this.src='images/Resim7.png'" /></a></th>

<th bordercolor="white" bgcolor="yellow" align="left" colspan="4"><a href="adreskayit.php" target="sag" ><img src="images/Resim9.png" width="180" height="30" onmousemove="this.src='images/Resim10.png'" onmouseout="this.src='images/Resim9.png'" /></a></th>
</tr>
</table>
...
<th width="50%" colspan="8" bordercolor="white" bgcolor="yellow"><input name="button" type="button" onclick="kontrolil();" value="İl Kaydı Kontrol" onsubmit="javascript:reloadPage(this)" style="color:#000000;font-weight:bold;background:#66FF00" onmouseover="this.style.color='orange'" onmouseout="this.style.color='black'" /></th>
...
<th bordercolor="white" bgcolor="yellow"  colspan="4" align="left"><input name="submit2" type="button" value="İlçe Kaydı Kontrol" onclick="kontrolilce();" onsubmit="javascript:reloadPage(this)" style="color:#000000;font-weight:bold;background:#66FF00" onmouseover="this.style.color='orange'" onmouseout="this.style.color='black'" /></th>
...
<th bordercolor="white" bgcolor="yellow"  colspan="16"><input name="submit3" type="button" value="Kurum Kaydı Kontrol" onclick="kontrolkurum();" onsubmit="javascript:reloadPage(this)" style="color:#000000;font-weight:bold;background:#66FF00" onmouseover="this.style.color='orange'" onmouseout="this.style.color='black'" /></th>
...
<th bordercolor="white" bgcolor="yellow"  colspan="8"><input name="submit3" type="button" value="Kullanıcıları Listele" onclick="kontroluser();" onsubmit="javascript:reloadPage(this)" style="color:#000000;font-weight:bold;background:#66FF00" onmouseover="this.style.color='orange'" onmouseout="this.style.color='black'" /></th>	
...
?>
  ...
  <th bordercolor="white" bgcolor="yellow"  colspan="16"><a href="../frm023kayit.php" style="color:#000000;font-weight:bold;background:#66FF00" onmouseover="this.style.color='orange'" onmouseout="this.style.color='black'" ><? echo $apc ; ?></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="../cikis.php" style="color:#000000;font-weight:bold;background:#66FF00" onmouseover="this.style.color='orange'" onmouseout="this.style.color='black'" ><? echo $cikis ; ?></a></th>
</tr>
</table>
