...
<thead>  
  ...
  <tr>
   ...
   <tr>
    ...
    <th  width="100%" align="left" colspan="20"  class="border-0 "><?php $hastaliste="tarihli hasta listesi ektedir."; echo '<font size="3" family="Arial">'.$ilinadi.'-'.$ilceninadi.' '.$kurum.' '.$noktatarih.' '.$hastaliste.'</font>' ;?></th>
  </tr>
  <tr>
...
<tr>
  <th  width="100%" align="left" colspan="20"  class="border-0" class="style5"><?php echo '<font size="3" family="Arial">'.$verim38.'</font>'; ?></th>
  </tr>		
<tr>
  <th  width="100%" align="left" colspan="20"  class="border-0"><?php echo '<font size="3" family="Arial">'.$verim40.'</font>'; ?></th>
  </tr>		
   <tr>
	<th width="100%" align="center" colspan="20"  class="border-0" class="style5"><?php echo $ikametbaslik; ?></th>
  </tr>
       <tr>
