...
if(mysqli_query($dbhabe,$kayit)){
	...
	Kayıt Eklenemedi... <i class="fa fa-reply-all fa-lg"></i> Geri</button></div>';		
		echo'<meta http-equiv=refresh content="3; url=http://'.$siteadresi.'/byethost/c3c4/index.php" />
		<a href="http://'.$siteadresi.'/byethost/c3c4/index.php" _fcksavedurl="http://'.$siteadresi.'/byethost/c3c4/index.php">Oturum Sonlandırıldı Tekrar Giriş Yapınız....</a>';
	 }
	}else{ echo '<label><font style="color:Red">Oturum Sonlandırıldı Tekrar Giriş Yapınız....</font></label><meta http-equiv=refresh content="3; url=http://'.$siteadresi.'/byethost/c3c4/index.php" /><a href="http://'.$siteadresi.'/byethost/c3c4/index.php" _fcksavedurl="http://'.$siteadresi.'/byethost/c3c4/index.php"></a>';
	echo'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
?>
<?php
