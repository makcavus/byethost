...
if($yilgelen==""){
$resultvyil = @mysqli_query($dbh,"select * from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen')") ;
}elseif($ilgelen>0 and $yilgelen>0){
  $resultvyil = @mysqli_query($dbh,"select * from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi='$yilgelen')") ;
}
