...
//echo $kacaheksay;
//echo '<br>';
$kacveri="select * from veri where(ilidi='$countryId' and ilceidi='$stateId' and v176 like 'Dr.%' and v177 like '%Nolu A%' and vyiladi='$yil' and vayadi='$ay' or ilidi='$countryId' and ilceidi='$stateId' and v176 like 'Uzm.Dr.%' and v177 like '%Nolu A%' and vyiladi='$yil' and vayadi='$ay')";
...
WHERE left(ocak.socad,5)='$kod' and veri.vocadi IS NULL order by ocak.socad asc";
