...
<body>
<?php 
echo '<label><font size="2px" style="color:red" face="tahoma">Bu Kayd� Silmek �stedi�inize Emin misiniz?</font></label>';
echo '<br>';
echo '<a href="#" tabindex="1" title="hayir" onClick="kontrol();"><img src="images/hayir.png"></a>';
echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
echo '<a href="#" tabindex="2" title="evet" onClick="barkodsil();"><img src="images/evet.png"></a>'
?>
<!-- Optional JavaScript -->
