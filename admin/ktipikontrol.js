...
var selecttip = document.form7.selecttip.value;
var tipgir = document.form7.tipgir.value;

    http.open('get', noCache('tipkdegistir.php?selecttip='+selecttip+'&tipgir='+tipgir));
...
function cevapFonksiyonu() {
    if(http.readyState == 4){
        document.getElementById('sonucbirimtip').innerHTML = http.responseText;
 }
}
