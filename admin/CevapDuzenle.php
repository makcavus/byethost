...
$cevap=iconv("utf-8","iso-8859-9",$_GET['Cevap']);
	
//$email=$_GET["EmailAdresi"].'<br>';
//echo $_GET["Id"].'<br>';
//echo $_GET["CTarih"].'<br>';
//echo $cevap;
//echo $email;
...
$SQLInsert="update bizeulasin SET cevaptarihi='".$_GET["CTarih"]."', cevap='$cevap', yayinda='".$_GET["yayin"]."' where(iltiid='".$_GET["Id"]."')";
 ...
 if(mysql_query($SQLInsert)){
	 ...
	 //echo $_GET["yayin"];
	 //exit;
 echo '<br><div class="alert-info"><a href="cevapla.php?iltiid='.$_GET["Id"].'" class="form-control btn btn-success btn-sm"> Cevabınız Değiştirildi. Teşekkür Ederiz...<i class="fa fa-reply-all fa-lg"></i> Geri</a></div>';
 ...
 //echo $_GET["AdSoyad"];
	 ...
	 //echo mysql_error();
 echo '<br><div class="alert-info">Cevabınız Değiştirilemedi.Tekrar deneyiniz.<a href="cevapla.php?iltiid='.$_GET["Id"].'" class="form-control btn btn-warning btn-sm"><i class="fa fa-reply-all fa-lg"></i> Geri</a></div>';
 echo '<meta http-equiv=refresh content="5; url=http://'.$siteadresi.'/site-bs/form013/admin/ilekle.php" /><a href="http://'.$siteadresi.'/site-bs/form013/admin/ilekle.php" _fcksavedurl="http://'.$siteadresi.'/site-bs/form013/admin/ilekle.php"></a>';
