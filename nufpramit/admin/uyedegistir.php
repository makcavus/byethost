...
<th class="style6" width="50%" align="center" bordercolor="white" bgcolor="blue"><font size="4" color="yellow">Kullanıcı Kayıt Değiştirme Ekranı</font></th>
...
<tr>
<input type="hidden" name="krselectilno" id="krselectilno" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="<? echo $asmadi ;?>" />


          <th >Doktor Adı:</th>
          <th>
            <input id="kurumgirdeg" name="kurumgirdeg" class="style1"  type="text" value="<?php echo $ilcenom ; ?>">
          </th>

 <th>Kullanıcı Adı:</th>
            <th><input id="asmgir" name="asmgir" class="style1"  type="text" value="<?php echo $ilnom ; ?>">
          </th>  
		  <th >Kullanıcı Şifresi:</th> 
		  <th>
            <input id="tbbgir" name="tbbgir" class="style1"  type="text" value="<?php echo $kurumadi ; ?>">
          </th> 
</tr>
   </table> 
</form></div>
