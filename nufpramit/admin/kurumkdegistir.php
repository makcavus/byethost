...
//if($say<1){
$kayit="UPDATE ocak SET  socad='$kurumgelenx',asmadi='$asmgelenx',dradi='$drgelenx',aseadi='$asegelenx',aseunvan='$aseungelenx' where(ilinad='$ilseckrgelen' and ilce='$ilceseckrgelen' and socad='$degkurumgelenx')";
//}
...
$onceki="Kurum Bilgileri";
$sonraki="değiştirildi...";
echo '<label><font style="color:blue">'.$onceki.' '.$sonraki.'<a href="ilekle.php"  onclick="history.back();" onsubmit="javascript:reloadPage(this)">Geri</a></font></label></th></table>';
}else{
echo '<br>';
echo '<table class="cizgi" border="2" align="center" cellpadding="0" cellspacing="0" width="76%">';
