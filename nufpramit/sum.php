...
//GEBE
$gebearti = @mysql_query("select sum(v119+v120) as gsonucarti from yg where(ilidi='$ilgelen' and vyiladi<'$yilgelen')") ;
...
$gebeeksi = @mysql_query("select sum(v121+v122+v123+v124) as gsonuceksi from yg where(ilidi='$ilgelen' and vyiladi<'$yilgelen')") ;
...
//BEBEK
$bebekarti = @mysql_query("select sum(v128+v129+v130) as bsonucarti from yg where(ilidi='$ilgelen' and vyiladi<'$yilgelen')") ;
...
//echo $Toplambarti;
$bebekeksi = @mysql_query("select sum(v131+v132+v133) as bsonuceksi from yg where(ilidi='$ilgelen' and vyiladi<'$yilgelen')") ;
...
//LOHUSA
$lohusaarti = @mysql_query("select sum(v137+v138+v139) as lsonucarti from yg where(ilidi='$ilgelen' and vyiladi<'$yilgelen')") ;
...
//echo $Toplamlarti;
$lohusaeksi = @mysql_query("select sum(v140+v141+v142) as lsonuceksi from yg where(ilidi='$ilgelen' and vyiladi<'$yilgelen')") ;
...
//COCUK
$cocukarti = @mysql_query("select sum(v145+v146+v147) as csonucarti from yg where(ilidi='$ilgelen' and vyiladi<'$yilgelen')") ;
...
//echo $Toplamcarti;
$cocukeksi = @mysql_query("select sum(v148+v149+v150) as csonuceksi from yg where(ilidi='$ilgelen' and vyiladi<'$yilgelen')") ;
...
}else if($ilcegelen!="Il�e Se�iniz"){
$resultvyil = @mysql_query("select 
sum(v1) as v1,
sum(v2) as v2, 
sum(v3) as v3,
...
$odbaslik="ÖĞRENİM DURUMU GRAFİĞİ";
