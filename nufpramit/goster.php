...
<tr>
    <th width="27%" align="center"bordercolor="#000000" bgcolor="white" class="style5" colspan="4"><? $top="KURUM/A.HEK.BİRİMİ DEMOGRAFİK VERİLERİ"; echo '<font size="3" family="Arial"><label>'.trsuz($ilinadi).'-'.trsuz($ilceninadi).'-'.trsuz($socadi).'-'.$yilgelen.' '.trsuz($top).'</label></font>' ; ?></th>
</tr>
  <tr class="style5">
