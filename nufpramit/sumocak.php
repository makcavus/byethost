...
v176 as v176,
v177 as v177
from yg where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen')") ;
}else{
$resultvyil = @mysql_query("select 
sum(v1) as v1,
sum(v2) as v2, 
...
v176 as v176,
v177 as v177
from yg where(ilidi='$ilgelen' and vyiladi='$yilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen')") ;
}
$yili="YILI";
