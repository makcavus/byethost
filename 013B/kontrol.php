...
FROM ocak ocak
LEFT OUTER JOIN verib verib ON ocak.ilinad=verib.ilidi and ocak.ilce=verib.ilceidi and ocak.socad = verib.vocadi and verib.v176 like 'Dr.%' and verib.v177 like '%Nolu A%' and 
verib.vyiladi='$yil' and verib.vayadi='$ay' or ocak.ilinad=verib.ilidi and ocak.ilce=verib.ilceidi and ocak.socad = verib.vocadi and verib.v176 like 'Uzm.Dr.%' and verib.v177 like '%Nolu A%' and verib.vyiladi='$yil' and verib.vayadi='$ay'
WHERE left(ocak.socad,5)='$kod' and verib.vocadi IS NULL order by ocak.socad asc";
