...
echo '<label><font style="color:blue">'.$ilcegelenx.' '.$onceki.' '.$ilcedeggelenx.' '.$sonraki.'<a href="ilekle.php"  onclick="history.back();" onsubmit="javascript:reloadPage(this)">Geri</a></font></label></th></table>';
}else{
echo '<br>';
echo '<table class="cizgi" border="2" align="center" cellpadding="0" cellspacing="0" width="76%">';
...
echo '</tr>';
echo '<th bordercolor="white" bgcolor="yellow" bgcolor="yellow">';
echo '<label><font style="color:Red">İlçe Değiştirilemedi</label><a href=# onClick="kontrolilce();"><img src="images/iptal.png"></a></th></table>';
echo mysql_error();
 }
