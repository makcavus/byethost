...
}elseif($ilseckrgelen != "" and $ilceseckrgelen== trsuz("İlçe Seçiniz") and $say2<1){
$uyar=trsuz("İlçe Seçilmedi");
echo '<font style="color:Red">'.$uyar.'</font>' ;
}elseif($ilseckrgelen != "" and $ilceseckrgelen !="" and $kurumgelen=="" and $say2<1){
$uyar=trsuz("Kurum Seçilmedi");
echo '<font style="color:Red">'.$uyar.'</font>' ;
}elseif($ilseckrgelen != ""  and $ilceseckrgelen!= trsuz("İlçe Seçiniz") and $kurumgelen!="" and $say2<1){
