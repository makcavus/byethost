...
if(mysqli_query($dbh,$kayit)){
    ...
    echo'<meta http-equiv=refresh content="10; url=http://'.$siteadresi.'/site-bs/013B/frm023kayit.php" /><a href="http://'.$siteadresi.'/site-bs/013B/frm023kayit.php" _fcksavedurl="http://'.$siteadresi.'/site-bs/013B/frm023kayit.php">Tekrar deneyiniz.</a>';
    echo mysqli_error();
}
@mysqli_close($dbh);
?>
