...
//GEBE
$gebearti = @mysql_query("select sum(v119+v120) as gsonucarti from veri where(ilidi='$ilgelen' and vyiladi<'$yilgelen')") ;
...
$gebeeksi = @mysql_query("select sum(v121+v122+v123+v124) as gsonuceksi from veri where(ilidi='$ilgelen' and vyiladi<'$yilgelen')") ;
...
//BEBEK
$bebekarti = @mysql_query("select sum(v128+v129+v130) as bsonucarti from veri where(ilidi='$ilgelen' and vyiladi<'$yilgelen')") ;
...
//echo $Toplambarti;
$bebekeksi = @mysql_query("select sum(v131+v132+v133) as bsonuceksi from veri where(ilidi='$ilgelen' and vyiladi<'$yilgelen')") ;
...
//LOHUSA
$lohusaarti = @mysql_query("select sum(v137+v138+v139) as lsonucarti from veri where(ilidi='$ilgelen' and vyiladi<'$yilgelen')") ;
...
//echo $Toplamlarti;
$lohusaeksi = @mysql_query("select sum(v140+v141+v142) as lsonuceksi from veri where(ilidi='$ilgelen' and vyiladi<'$yilgelen')") ;
...
//COCUK
$cocukarti = @mysql_query("select sum(v145+v146+v147) as csonucarti from veri where(ilidi='$ilgelen' and vyiladi<'$yilgelen')") ;
...
//echo $Toplamcarti;
$cocukeksi = @mysql_query("select sum(v148+v149+v150) as csonuceksi from veri where(ilidi='$ilgelen' and vyiladi<'$yilgelen')") ;
