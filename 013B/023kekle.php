...
if($say<1){
    ...
    if(mysqli_query($dbh,$kayit)){
        ...
        echo'<meta http-equiv=refresh content="10; url=http://'.$siteadresi.'/site-bs/013B/index.php" /><a href="http://'.$siteadresi.'/site-bs/013B/index.php" _fcksavedurl="http://'.$siteadresi.'/site-bs/013B/index.php">Oturum Sonlandırıldı Tekrar Giriş Yapınız....</a>';

    }
}else{ echo '<label><font style="color:Red">Oturum Sonlandırıldı Tekrar Giriş Yapınız....</font></label><meta http-equiv=refresh content="10; url=http://'.$siteadresi.'/site-bs/013B/index.php" /><a href="http://'.$siteadresi.'/site-bs/013B/index.php" _fcksavedurl="http://'.$siteadresi.'/site-bs/013B/index.php"></a>';
    echo'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
    ?>
    <?php
