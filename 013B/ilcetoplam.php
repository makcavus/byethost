...
if($yilgelen==""){
  $nuf=@mysqli_query($dbh,"select distinct vyiladi,vayadi from verib where ilidi='$ilgelen' and ilceidi='$ilcegelen'");
}elseif($ilcegelen>0 and $yilgelen>0){
  $nuf=@mysqli_query($dbh,"select distinct vyiladi,vayadi from verib where ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi='$yilgelen'");
}
...
if($yilgelen==""){
$resultvyil = @mysqli_query($dbh,"select * from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen')") ;
}elseif($ilgelen>0 and $yilgelen>0){
  $resultvyil = @mysqli_query($dbh,"select * from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi='$yilgelen')") ;
}
