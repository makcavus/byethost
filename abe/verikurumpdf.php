...
$pdf->MultiCell(80,4,$ocgelen,0,'L');

$pdf->SetY(28);
$pdf->SetX(15);
$pdf->Cell(25,4,trsuz('Dönem/Tarih:'),0,0,'L',1);
$pdf->MultiCell(80,4,$ay,0,'L');
...
$pdf->Cell(105,6,$verim173,1,0,'L',1);

$pdf->SetY(151);
$pdf->SetX(160);
$pdf->Cell(25,6,trsuz('Adı Soyadı:'),1,0,'R',1);
$pdf->Cell(105,6,$verim176,1,0,'L',1);

$pdf->SetY(157);
$pdf->SetX(15);
$pdf->Cell(25,6,trsuz('Ünvanı/Görevi:'),1,0,'R',1);
$pdf->Cell(105,6,$verim174,1,0,'L',1);

$pdf->SetY(157);
$pdf->SetX(160);
$pdf->Cell(25,6,trsuz('Ünvanı/Görevi:'),1,0,'R',1);
$pdf->Cell(105,6,$verim177,1,0,'L',1);
