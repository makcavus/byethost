...
//IMPLANT
$imparti = @mysql_query("select sum(v32+v33) as xsonucarti from veri where(ilidi='$ilgelen' and vyiladi<'$yilgelen')") ;
...
//echo $Toplamcarti;
$impeksi = @mysql_query("select sum(v34+v35+v36) as xsonuceksi from veri where(ilidi='$ilgelen' and vyiladi<'$yilgelen')") ;
