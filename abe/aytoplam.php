...
<?php
echo '<form action="aypdf.php" method="get" name="gor" target="hoppa" onSubmit="hoppa()">' ;
...
echo '<form action="topgrafikay.php" method="get" name="gor" target="hoppa" onSubmit="hoppa()">' ;
echo '<input type="hidden" name="selectil" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="'.$ilgelen.'" />';
...
echo '<form action="/excelmysql/abeayxls.php" method="get" name="gor">' ;
...
<table class="cizgi" border="0" bordercolor="#FFFFFF" align="center" cellpadding="0" cellspacing="0" width="100%">
    <tr>
    <th width="27%" align="center"bordercolor="#000000" bgcolor="white" class="style5"><? echo '<font size="3" family="Arial"><label>'.trsuz($ilinadi).'-'.trsuz($ilceninadi).'-'.trsuz($kurum).'-'.$yilgelen.'-'.trsuz($aygelen).'</label></font>' ; ?></th>
</tr>
</table> 
<br>
<table class="cizgi" border="0" bordercolor="#FFFFFF" align="center" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
    ...
    <th  width="88%"align="left" bordercolor="white" colspan="11"><? echo '<font size="3" family="Arial">'.trsuz($aygelen).'-'.$yilgelen.'</font>' ;?></th>
  </tr>
  <tr>
    <th  width="100%"align="center" bordercolor="white" colspan="12">&nbsp;</th>
  </tr>
