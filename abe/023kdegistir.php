...
if(mysqli_query($dbhabe,$kayit)){
	...
	echo'<meta http-equiv=refresh content="10; url=http://'.$siteadresi.'/byethost/abe/frm023kayit.php" /><a href="http://'.$siteadresi.'/byethost/abe/frm023kayit.php" _fcksavedurl="http://'.$siteadresi.'/byethost/abe/frm023kayit.php">Tekrar deneyiniz.</a>';
	echo mysqli_error();
	 }
	@mysqli_close($dbhabe);
	 ?>
