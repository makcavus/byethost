...
<style type="text/css">
<!-- 
body{background-image:url(images/antique-key.jpg);background-attachment: fixed; background-repeat:repeat;} 
-->
</style>
...
mysql_connect("sql304.byetcluster.com","b12_10384566","malika") or die("mysql veritabanına bağlanılamıyor"); //root adlÄ± kullanÄ±cÄ± yok ise mysqle baÄŸlanamÄ±yorsunuz



mysql_select_db("b12_10384566_frm013") or die("veritabanı seçilemiyor"); //veri tabanÄ±nÄ±zda bÃ¶le bir veritabanÄ± oluÅŸturulmadÄ±ÄŸÄ±ndan veritabanÄ± seÃ§ilemiyor
