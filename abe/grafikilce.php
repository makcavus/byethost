...
$vtsec="select sum(v21) as A09T,sum(v22) as R11T,sum(v23) as K52T from veri where ilidi='$ilgelen' and ilceidi='$ilcegelen' and (vayadi between '$baslangic' and '$bugun') group by vayadi order by vayadi asc";
...
$vtsec="select * from veri where ilidi='$ilgelen' and ilceidi='$ilcegelen' and (vayadi between '$baslangic' and '$bugun') group by vayadi order by vayadi asc";
