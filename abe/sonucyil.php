...
$ilkgelen=iconv("UTF-8", "ISO-8859-9", $_GET['selecttarilk']); 
$songelen=iconv("UTF-8", "ISO-8859-9", $_GET['selecttarson']); 
$tarihilkal=substr($ilkgelen,0,10);
$tarihsonal=substr($songelen,0,10);
//$ocakyazi=iconv("UTF-8", "ISO-8859-9", $_GET['selectoc']);
include('sumkarsilastirmaucyil.php');
//include('deviray.php');
/*echo $ilgelen ;
echo $ilcegelen ;
echo $ocgelen ;
...
echo '<form action="topgrafikucyil.php" method="get" name="gor" target="hoppa" onSubmit="hoppa()">';
echo '<input type="hidden" name="selectil" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="'.trsuz($ilgelen).'" />';
echo '<input type="hidden" name="selectilce" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="'.trsuz($ilcegelen).'" />';
echo '<input type="hidden" name="selectoc" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="'.trsuz($ocgelen).'" />';
echo '<input type="hidden" name="selectyil" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="'.$yilgelen.'" />';
...
?><input TYPE="SUBMIT" value="<?php echo trsuz($topgrafciz) ;?>"  style="color:#000000;font-weight:bold;background:#66FF00" onmouseover="this.style.color='orange'" onmouseout="this.style.color='black'"/>
<?
echo '</form>';
?></th>
<th class="style6" width="52%" align="center" bordercolor="#FFCC00" bgcolor="blue"><font size="4" color="yellow"><?php echo trsuz($sonikiyilarasibaslik) ;?></font></th>
...
<table class="cizgi" border="0" bordercolor="#FFFFFF" align="center" cellpadding="0" cellspacing="0" width="100%">
    <tr>
    <th width="100%" align="center"bordercolor="#000000" bgcolor="white" class="style5"><?php $ile="ile"; $ikiyil=" (2 YIL ÖNCEKİ AYNI DÖNEM KARŞILAŞTIRMASI) (Pembe:Önceki Yıl, Sarı:Bu Yıl)"; $ikiyilx=" (2 YIL ÖNCEKİ AYNI DÖNEM KARŞILAŞTIRMASI)"; $aralik="Tarihleri Arası"; echo '<font size="3" family="Arial"><label>'.trsuz($ilinadi).'-'.trsuz($ilceninadi).'-'.trsuz($kurum).'-'.$oncekitarihilkal.'-'.$oncekitarihsonal.' '.$ile.' '.$tarihilkal.'-'.$tarihsonal.' '.trsuz($ikiyilx).' '.trsuz($top).'</label></font>' ; ?></th>
</tr>
</table> 
<br>
<table class="cizgi" border="0" bordercolor="#FFFFFF" align="center" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    <th  width="100%" align="center"bordercolor="white" colspan="24"><font size="3"><?php echo trsuz($frmbaslik) ;?></font></th>
  </tr>
  <tr>
    <th  width="100%" align="center" bordercolor="white" colspan="24">&nbsp;</th>
  </tr>
  <tr>
    <th  width="16%" align="left"bordercolor="white" colspan="1"><?php echo trsuz($ililcebaslik) ;?></th>
    <th  width="84%" align="left" bordercolor="white" colspan="23"><? echo '<font size="3" family="Arial">'.trsuz($ililce).'</font>' ;?></th>
  </tr>
  <tr>
    <th  width="16%" align="left" bordercolor="white" colspan="1">Kurum:</th>
    <th  width="84%" align="left" bordercolor="white" colspan="23"><? echo '<font size="3" family="Arial">'.trsuz($kurum).'</font>' ;?></th>
  </tr>
  <tr>
    <th  width="16%" align="left"bordercolor="white" colspan="1"><?php echo trsuz($donembaslik) ;?></th>
    <th  width="84%" align="left" bordercolor="white" colspan="23"><? echo '<font size="3" family="Arial">'.$oncekitarihilkal.'-'.$oncekitarihsonal.' '.$ile.' '.$tarihilkal.'-'.$tarihsonal.' '.trsuz($ikiyil).'</font>' ;?></th>
  </tr>
  <tr>
    <th  width="100%" align="center" bordercolor="white" colspan="24">&nbsp;</th>
  </tr>
  <tr>
    <th  width="84%" align="center" class="style5" bgcolor="white" colspan="20"><font face="Arial" size="3"><?php echo trsuz($abevakabaslik) ;?></font></th>
    <th  width="16%" align="center" bgcolor="white" colspan="4"><font face="Arial" size="3">&nbsp;</font></th>
  </tr>
  <tr>
    <th  width="32%" align="center" class="style5" bgcolor="#CEF6EC" colspan="8" rowspan="2"><font face="Arial" size="3"><?php echo trsuz($hastsinifbaslik) ;?></font></th>
    <th  width="16%" align="center" class="style5" bgcolor="#CEF6EC" colspan="4"><font face="Arial" size="3">A09</font><br />
        <font face="Arial" size="2">Diyare ve gastroenterit,</font><br />
        <font face="Arial" size="2"><?php echo trsuz($adenfbaslik) ;?></font><br />
        <font face="Arial" size="2">tahmin edilen </font></th>
    <th  width="16%" align="center" class="style5" bgcolor="#CEF6EC" colspan="4"><font face="Arial" size="3">R11</font><br />
        <font face="Arial" size="2">&nbsp;</font><br />
        <font face="Arial" size="2">&nbsp;</font><br />
        <font face="Arial" size="2"><?php echo trsuz($ronbirbaslik) ;?></font></th>
    <th  width="16%" align="center" class="style5" bgcolor="#CEF6EC" colspan="4"><font face="Arial" size="3">K52</font><br />
        <font face="Arial" size="2">&nbsp;</font><br />
        <font face="Arial" size="2"><?php echo trsuz($keienfbaslik) ;?></font><br />
        <font face="Arial" size="2">gastroenterit ve kolit</font></th>
    <th  width="20%" align="center" bgcolor="white" colspan="4"><font face="Arial" size="3">&nbsp;</font></th>
  </tr>
  <tr>
    <th  width="8%" align="center" class="style5" bgcolor="#CEF6EC" colspan="2"><font face="Arial" size="2"><?php echo trsuz($sifiryasbaslik) ;?></font></th>
    <th  width="8%" align="center" class="style5" bgcolor="#CEF6EC" colspan="2"><font face="Arial" size="2"><?php echo trsuz($besyasbaslik) ;?></font></th>
    <th  width="8%" align="center" class="style5" bgcolor="#CEF6EC" colspan="2"><font face="Arial" size="2"><?php echo trsuz($sifiryasbaslik) ;?></font></th>
    <th  width="8%" align="center" class="style5" bgcolor="#CEF6EC" colspan="2"><font face="Arial" size="2"><?php echo trsuz($besyasbaslik) ;?></font></th>
    <th  width="8%" align="center" class="style5" bgcolor="#CEF6EC" colspan="2"><font face="Arial" size="2"><?php echo trsuz($sifiryasbaslik) ;?></font></th>
    <th  width="8%" align="center" class="style5" bgcolor="#CEF6EC" colspan="2"><font face="Arial" size="2"><?php echo trsuz($besyasbaslik) ;?></font></th>
    <th  width="8%" align="center" bgcolor="white" colspan="2"><font face="Arial" size="2">&nbsp;</font></th>
    <th  width="8%" align="center" bgcolor="white" colspan="2"><font face="Arial" size="2">&nbsp;</font></th>
  </tr>
  <tr>
    <th  width="32%" align="center" class="style5" bgcolor="#CEF6EC" colspan="8"><font face="Arial" size="3"><?php echo trsuz($vakasaybaslik) ;?></font></th>
    <th  width="4%" align="center" class="style5" bgcolor="#FFCCCC" colspan="1"><?php echo $ikiverim1; ?></th><th  width="4%" align="center" class="style5" bgcolor="#FFFFCC" colspan="1"><?php echo $verim1; ?></th>
    <th  width="4%" align="center" class="style5" bgcolor="#FFCCCC" colspan="1"><?php echo $ikiverim2; ?></th><th  width="4%" align="center" class="style5" bgcolor="#FFFFCC" colspan="1"><?php echo $verim2; ?></th>
    <th  width="4%" align="center" class="style5" bgcolor="#FFCCCC" colspan="1"><?php echo $ikiverim3; ?></th><th  width="4%" align="center" class="style5" bgcolor="#FFFFCC" colspan="1"><?php echo $verim3; ?></th>
    <th  width="4%" align="center" class="style5" bgcolor="#FFCCCC" colspan="1"><?php echo $ikiverim4; ?></th><th  width="4%" align="center" class="style5" bgcolor="#FFFFCC" colspan="1"><?php echo $verim4; ?></th>
    <th  width="4%" align="center" class="style5" bgcolor="#FFCCCC" colspan="1"><?php echo $ikiverim5; ?></th><th  width="4%" align="center" class="style5" bgcolor="#FFFFCC" colspan="1"><?php echo $verim5; ?></th>
    <th  width="4%" align="center" class="style5" bgcolor="#FFCCCC" colspan="1"><?php echo $ikiverim6; ?></th><th  width="4%" align="center" class="style5" bgcolor="#FFFFCC" colspan="1"><?php echo $verim6; ?></th>
    <th  width="4%" align="center" bgcolor="white" colspan="1"><font face="Arial" size="3">&nbsp;</font></th><th  width="4%" align="center" bgcolor="white" colspan="1"><font face="Arial" size="3">&nbsp;</font></th>
    <th  width="6%" align="center" bgcolor="white" colspan="1"><font face="Arial" size="2">&nbsp;</font></th><th  width="6%" align="center" bgcolor="white" colspan="1"><font face="Arial" size="3">&nbsp;</font></th>
  </tr>
  <tr>
    <th  width="100%" align="center" bordercolor="white" colspan="24">&nbsp;</th>
  </tr>
  <tr>
    <th  width="100%" align="center" class="style5" bgcolor="white" colspan="24"><font face="Arial" size="3"><?php echo trsuz($labbaslik) ;?></font></th>
  </tr>
  <tr>
    <th  width="16%" align="center" class="style5" bgcolor="#CEF6EC" colspan="4"><font face="Arial" size="2"><?php echo trsuz($kulturbaslik) ;?></font></th>
    <th  width="16%" align="center" class="style5" bgcolor="#CEF6EC" colspan="4"><font face="Arial" size="2">Vibrio cholerae (A00)</font></th>
    <th  width="16%" align="center" class="style5" bgcolor="#CEF6EC" colspan="4"><font face="Arial" size="2">Salmonella sp.(A02)</font></th>
    <th  width="16%" align="center" class="style5" bgcolor="#CEF6EC" colspan="4"><font face="Arial" size="2">Shigella sp.(A03)</font></th>
    <th  width="16%" align="center" class="style5" bgcolor="#CEF6EC" colspan="4"><font face="Arial" size="2">Enterohemorrhagic</font><br />
        <font face="Arial" size="2">Escherichia Coli (A04.3)</font></th>
    <th  width="20%" align="center" class="style5" bgcolor="#CEF6EC" colspan="4"><font face="Arial" size="2">Campylobacter (A04.5)</font></th>
  </tr>
  <tr>
    <th  width="8%" align="center" class="style5" bgcolor="#FFCCCC" colspan="2"><?php if($ikiverim7==NULL){$ikiverim7="&nbsp;"; }else{$ikiverim7=$ikiverim7; }  echo $ikiverim7; ?></th>
    <th  width="8%" align="center" class="style5" bgcolor="#FFFFCC" colspan="2"><?php if($verim7==NULL){$verim7="&nbsp;"; }else{$verim7=$verim7; }  echo $verim7; ?></th>
    <th  width="8%" align="center" class="style5" bgcolor="#FFCCCC" colspan="2"><?php echo $ikiverim8; ?></th>
    <th  width="8%" align="center" class="style5" bgcolor="#FFFFCC" colspan="2"><?php echo $verim8; ?></th>
    <th  width="8%" align="center" class="style5" bgcolor="#FFCCCC" colspan="2"><?php echo $ikiverim9; ?></th>
    <th  width="8%" align="center" class="style5" bgcolor="#FFFFCC" colspan="2"><?php echo $verim9; ?></th>
    <th  width="8%" align="center" class="style5" bgcolor="#FFCCCC" colspan="2"><?php echo $ikiverim10; ?></th>
    <th  width="8%" align="center" class="style5" bgcolor="#FFFFCC" colspan="2"><?php echo $verim10; ?></th>
    <th  width="8%" align="center" class="style5" bgcolor="#FFCCCC" colspan="2"><?php echo $ikiverim11; ?></th>
    <th  width="8%" align="center" class="style5" bgcolor="#FFFFCC" colspan="2"><?php echo $verim11; ?></th>
    <th  width="10%" align="center" class="style5" bgcolor="#FFCCCC" colspan="2"><?php echo $ikiverim12; ?></th>
    <th  width="10%" align="center" class="style5" bgcolor="#FFFFCC" colspan="2"><?php echo $verim12; ?></th>
  </tr>
  <tr>
    <th  width="16%" align="center" class="style5" bgcolor="#CEF6EC" colspan="4"><font face="Arial" size="2"><?php echo trsuz($parazitbaslik) ;?></font></th>
    <th  width="16%" align="center" class="style5" bgcolor="#CEF6EC" colspan="4"><font face="Arial" size="2">Entamoeba histolytica (A06)</font></th>
    <th  width="16%" align="center" class="style5" bgcolor="#CEF6EC" colspan="4"><font face="Arial" size="2">Cryptosporodium (A07.2)</font></th>
    <th  width="16%" align="center" bgcolor="white" colspan="4"><font face="Arial" size="2">&nbsp;</font></th>
    <th  width="16%" align="center" bgcolor="white" colspan="4"><font face="Arial" size="2">&nbsp;</font></th>
    <th  width="20%" align="center" bgcolor="white" colspan="4"><font face="Arial" size="2">&nbsp;</font></th>
  </tr>
  <tr>
    <th  width="8%" align="center" class="style5" bgcolor="#FFCCCC" colspan="2"><?php echo $ikiverim13; ?></th>
    <th  width="8%" align="center" class="style5" bgcolor="#FFFFCC" colspan="2"><?php echo $verim13; ?></th>
    <th  width="8%" align="center" class="style5" bgcolor="#FFCCCC" colspan="2"><?php echo $ikiverim14; ?></th>
    <th  width="8%" align="center" class="style5" bgcolor="#FFFFCC" colspan="2"><?php echo $verim14; ?></th>
    <th  width="8%" align="center" class="style5" bgcolor="#FFCCCC" colspan="2"><?php echo $ikiverim15; ?></th>
    <th  width="8%" align="center" class="style5" bgcolor="#FFFFCC" colspan="2"><?php echo $verim15; ?></th>
    <th  width="8%" align="center" bgcolor="white" colspan="2"><font face="Arial" size="2">&nbsp;</font></th>
    <th  width="8%" align="center" bgcolor="white" colspan="2"><font face="Arial" size="2">&nbsp;</font></th>
    <th  width="8%" align="center" bgcolor="white" colspan="2"><font face="Arial" size="2">&nbsp;</font></th>
    <th  width="8%" align="center" bgcolor="white" colspan="2"><font face="Arial" size="2">&nbsp;</font></th>
    <th  width="10%" align="center" bgcolor="white" colspan="2"><font face="Arial" size="2">&nbsp;</font></th>
    <th  width="10%" align="center" bgcolor="white" colspan="2"><font face="Arial" size="2">&nbsp;</font></th>
  </tr>
  <tr>
    <th  width="16%" align="center" class="style5" bgcolor="#CEF6EC" colspan="4"><font face="Arial" size="2"><?php echo trsuz($viralbaslik) ;?></font></th>
    <th  width="16%" align="center" class="style5" bgcolor="#CEF6EC" colspan="4"><font face="Arial" size="2"><?php echo trsuz($rotabaslik) ;?></font></th>
    <th  width="16%" align="center" class="style5" bgcolor="#CEF6EC" colspan="4"><font face="Arial" size="2"><?php echo trsuz($norobaslik) ;?></font></th>
    <th  width="16%" align="center" class="style5" bgcolor="#CEF6EC" colspan="4"><font face="Arial" size="2"><?php echo trsuz($adenobaslik) ;?></font></th>
    <th  width="16%" align="center" class="style5" bgcolor="#CEF6EC" colspan="4"><font face="Arial" size="2"><?php echo trsuz($hepabaslik) ;?></font></th>
    <th  width="20%" align="center" bgcolor="white" colspan="4"><font face="Arial" size="2">&nbsp;</font></th>
  </tr>
  <tr>
    <th  width="8%" align="center" class="style5" bgcolor="#FFCCCC" colspan="2"><?php echo $ikiverim16; ?></th>
    <th  width="8%" align="center" class="style5" bgcolor="#FFFFCC" colspan="2"><?php echo $verim16; ?></th>
    <th  width="8%" align="center" class="style5" bgcolor="#FFCCCC" colspan="2"><?php echo $ikiverim17; ?></th>
    <th  width="8%" align="center" class="style5" bgcolor="#FFFFCC" colspan="2"><?php echo $verim17; ?></th>
    <th  width="8%" align="center" class="style5" bgcolor="#FFCCCC" colspan="2"><?php echo $ikiverim18; ?></th>
    <th  width="8%" align="center" class="style5" bgcolor="#FFFFCC" colspan="2"><?php echo $verim18; ?></th>
    <th  width="8%" align="center" class="style5" bgcolor="#FFCCCC" colspan="2"><?php echo $ikiverim19; ?></th>
    <th  width="8%" align="center" class="style5" bgcolor="#FFFFCC" colspan="2"><?php echo $verim19; ?></th>
    <th  width="8%" align="center" class="style5" bgcolor="#FFCCCC" colspan="2"><?php echo $ikiverim20; ?></th>
    <th  width="8%" align="center" class="style5" bgcolor="#FFFFCC" colspan="2"><?php echo $verim20; ?></th>
    <th  width="10%" align="center" bgcolor="white" colspan="2">&nbsp;</th>
    <th  width="10%" align="center" bgcolor="white" colspan="2">&nbsp;</th>
  </tr>
  <tr>
    <th  width="100%" align="center" bordercolor="white" colspan="24">&nbsp;</th>
...
?>
  ...
  <tr>
    <th  width="32%" bgcolor="white" colspan="4" rowspan="6">&nbsp;</th>
  </tr>
  <tr>
    <th  width="16%" align="center" class="style5" bgcolor="#CEF6EC" colspan="6"><?php echo trsuz($duzbaslik) ;?></th>
    <th  width="16%" bgcolor="white" colspan="4" rowspan="5">&nbsp;</th>
    <th  width="16%" align="center" class="style5" bgcolor="#CEF6EC" colspan="6">ONAYLAYAN</th>
    <th  width="20%" bgcolor="white" colspan="4" rowspan="5">&nbsp;</th>
  </tr>
  <tr>
    <th  width="8%" align="left" class="style5" bgcolor="#CEF6EC" colspan="2">&nbsp;Ad/Soyad</th>
    <th  width="8%" align="left" class="style5" bgcolor="#FFFFCC" colspan="4"><? echo trsuz($asead) ; ?></th>
    <th  width="8%" align="left" class="style5" bgcolor="#CEF6EC" colspan="2">&nbsp;Ad/Soyad</th>
    <th  width="8%" align="left" class="style5" bgcolor="#FFFFCC" colspan="4"><? echo trsuz($drad) ; ?></th>
  </tr>
  <tr>
    <th  width="8%" align="left" class="style5" bgcolor="#CEF6EC" colspan="2">&nbsp;<?php echo trsuz($duzunbaslik) ;?></th>
    <th  width="8%" align="left" class="style5" bgcolor="#FFFFCC" colspan="4"><? echo trsuz($aseunv) ; ?></th>
    <th  width="8%" align="left" class="style5" bgcolor="#CEF6EC" colspan="2">&nbsp;<?php echo trsuz($onunbaslik) ;?></th>
    <th  width="8%" align="left" class="style5" bgcolor="#FFFFCC" colspan="4"><? echo trsuz($ahkod).' '.trsuz($ahno) ;?></th>
  </tr>
  <tr>
    <?php
...
$ontarih=$ongelentarihgun.'.'.$ongelentarihay.'.'.$ongelentarihyil; 
   ...
   ?>
    <th  width="8%" align="left" class="style5" bgcolor="#CEF6EC" colspan="2">&nbsp;Tarih</th>
    <th  width="8%" align="left" class="style5" bgcolor="#FFFFCC" colspan="4"><? echo $duztarih; ?></th>
    <th  width="8%" align="left" class="style5" bgcolor="#CEF6EC" colspan="2">&nbsp;Tarih</th>
    <th  width="8%" align="left" class="style5" bgcolor="#FFFFCC" colspan="4"><? echo $ontarih?></th>
  </tr>
  <tr>
    <th  width="8%" align="left" class="style5" bgcolor="#CEF6EC" colspan="2">&nbsp;<?php echo trsuz($duzimzabaslik) ;?></th>
    <th  width="8%" align="center" class="style5" bgcolor="#FFFFCC" colspan="4">&nbsp;</th>
    <th  width="8%" align="left" class="style5" bgcolor="#CEF6EC" colspan="2">&nbsp;<?php echo trsuz($onimzabaslik) ;?></th>
    <th  width="8%" align="center" class="style5" bgcolor="#FFFFCC" colspan="4">&nbsp;</th>
  </tr>
</table>
</form>
