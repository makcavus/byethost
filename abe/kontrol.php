...
<table witdth="100%" class="table table-responsive-sm table-bordered">
  <thead>
<th width="100%" class="text-center"><font size='2px' face='tahoma' color='red'><?php echo $kachastsay." ".$ahast." ".$girilmeyenhast." ".$bhast;?></font></th>
</thead>
</table>
<?php
}elseif($hastkacverisay>0  and $countryId !="" and $stateId != $ilcesecim and $ocak != $ahsecim){
...
<table width="100%" class="table table-responsive-sm table-bordered">
  <thead>
<th width="100%" class="text-center text-danger"><h5><span class="badge badge-pill badge-danger"><?php echo $bos;?></span></h5></th>
</thead>
</table>
<?php
