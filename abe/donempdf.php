...
if($donem=='ilk'){
	   $donemi=trsuz('1.DÖNEM (ÜÇ AYLIK)');
	   }elseif($donem=='ikinci'){
	   $donemi=trsuz('2.DÖNEM (ÜÇ AYLIK)');
	   }elseif($donem=='ucuncu'){
	   $donemi=trsuz('3.DÖNEM (ÜÇ AYLIK)');
	   }elseif($donem=='son'){
	   $donemi=trsuz('4.DÖNEM (ÜÇ AYLIK)');
	   } 
...
$pdf->MultiCell(80,4,$yilgelen.' '.trsuz('YILI').' '.$donemi,0,'L');
