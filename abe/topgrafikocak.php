...
$vtsec="select sum(v21+v22+v23) as TOPLAM from veri where ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and (vayadi between '$baslangic' and '$bugun') group by vayadi order by vayadi asc";
