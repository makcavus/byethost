...
<?php
echo '<form action="kurumpdf.php" method="get" name="gor" target="hoppa" onSubmit="hoppa()">' ;
...
echo '<input type="hidden" name="v173" value="'.trsuz($verim173).'" />';
echo '<input type="hidden" name="v174" value="'.trsuz($verim174).'" />';
echo '<input type="hidden" name="v175" value="'.$verim175.'" />';
echo '<input type="hidden" name="v176" value="'.trsuz($verim176).'" />';
echo '<input type="hidden" name="v177" value="'.trsuz($verim177).'" />';
...
echo '<form action="topgrafikocak.php" method="get" name="gor" target="hoppa" onSubmit="hoppa()">' ;
echo '<input type="hidden" name="selectil" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="'.$ilgelen.'" />';
...
?>
<input name="SUBMIT3" type="SUBMIT"  style="color:#000000;font-weight:bold;background:#66FF00" onmouseover="this.style.color='orange'" onmouseout="this.style.color='black'" value="<?php echo trsuz($topgrafciz); ?>"/>
<?
echo '</form>';
?></th>
<th class="style6" width="52%" align="center" bordercolor="#FFCC00" bgcolor="blue"><font size="4" color="yellow"><?php echo trsuz($ocakgorbaslik); ?></font></th>
<th class="style6" width="12%"align="right" bordercolor="#FFCC00" bgcolor="#FFCC00">
<?php
echo '<form action="grafikocak.php" method="get" name="gor" target="hoppa" onSubmit="hoppa()">' ;
echo '<input type="hidden" name="selectil" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="'.$ilgelen.'" />';
echo '<input type="hidden" name="selectilce" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="'.$ilcegelen.'" />';
echo '<input type="hidden" name="selectoc" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="'.trsuz($ocgelen).'" />';
echo '<input type="hidden" name="selectyil" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="'.$yilgelen.'" />';
...
echo '<form action="/excelmysql/abekurumxls.php" method="get" name="gor">' ;
...
<tr>
<?php
	if($ocgelen=="" or substr($ocgelen,-9)=="Hastanesi" or substr($ocgelen,-3)=="TSM"){
	$kurum=$asmninadine;
	}else{
	...
	?>
    <th width="27%" align="center"bordercolor="#000000" bgcolor="white" class="style5"><? $top=$kbbaslik; echo '<font size="3" family="Arial"><label>'.trsuz($ilinadi).'-'.trsuz($ilceninadi).'-'.trsuz($kurum).'-'.$yilgelen.' '.trsuz($top).'</label></font>' ; ?></th>
</tr>
<input type="hidden" name="selectil" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="<? echo $ilgelen ;?>" />
<input type="hidden" name="selectilce" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="<? echo $ilcegelen ;?>" />
<input type="hidden" name="selectoc" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="<? echo $ocgelen ;?>" />
...
<input type="hidden" name="v42" value="0" size="5"/>
  ...
  <tr>
    ...
    <th  width="16%"align="left" class="style5" bgcolor="#FFFFCC" colspan="2"><? echo trsuz($ahkod).' '.trsuz($ahno) ;?></th>
  </tr>
  <tr>
    <?php
