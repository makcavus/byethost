...
//IMPLANT
$imparti = @mysql_query("select sum(v32+v33) as xsonucarti from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi<'$yilgelen')") ;
...
//echo $Toplamcarti;
$impeksi = @mysql_query("select sum(v34+v35+v36) as xsonuceksi from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi<'$yilgelen')") ;
...
sum(v171) as v171,
sum(v172) as v172
from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen')") ;
}else{
$resultvyil = @mysql_query("select 
sum(v1) as v1,
sum(v2) as v2, 
...
sum(v171) as v171,
sum(v172) as v172
from veri where(ilidi='$ilgelen' and vyiladi='$yilgelen' and ilceidi='$ilcegelen')") ;
}
