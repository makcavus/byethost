...
$deggorbaslik="Kayıt Değiştirme Ekran�";
...
$tarihgorbaslik="Tarih Aralığı Toplamı Görüntüleme Ekranı";
$ikiyilarasibaslik="Tarih Aralığındaki Son 2 Yılı Karşılaştırma Ekranı";
$sonikiyilarasibaslik="Tarih Aralığındaki Son 2 Yılı Karşılaştırma Ekranı";
$tariharasi="Tarihleri Arası";
$pdfbaslik="PDF Yazdır";
$topgrafciz="Toplam Grafiği Çiz";
$icdgrafciz="ICD-10 Grafiği Çiz";
$excelbaslik="Excele Yazdır";
$iltopbaslik="İL TOPLAMI";
$ilcetopbaslik="İLÇE TOPLAMI";
$kbbaslik="KURUM/BİRİM TOPLAMI";
$frmbaslik="AKUT BARSAK ENFEKSİYONLARI GÜNLÜK SÜRVEYANS VE İZLEME-DEĞERLENDİRME FORMU";
$ililcebaslik="İl/İlçe:";
$kurumbaslik="Kurum:";
$donembaslik="Dönem/Tarih:";
$abevakabaslik="AKUT BARSAK ENFEKSİYONLARI GÜNLÜK SÜRVEYANS VE VAKA İZLEME FORMU";
$hastsinifbaslik="Hastalık Sınıflamaları";
$addiarebaslik="Diyare ve gastroenterit,";
$adenfbaslik="enfeksiyöz kaynaklı";
$adtahminbaslik="tahmin edilen";
$ronbirbaslik="Bulantı ve kusma";
$keienfbaslik="Enfektif olmayan diğer";
$keigastbaslik="gastroenterit ve kolit";
$sifiryasbaslik="0-59 aylık";
$besyasbaslik="5 yaş ve üzeri";
$vakasaybaslik="Vaka Sayısı";
$labbaslik="AKUT BARSAK ENFEKSİYONLARI GÜNLÜK SÜRVEYANS LABURATUVAR SONUÇLARI İZLEME-DEĞERLENDİRME FORMU";
$kulturbaslik="YAPILAN GAİTA KÜLTÜR SAYISI";
$parazitbaslik="YAPILAN GAİTA PARAZİT İNCELEME SAYISI";
$viralbaslik="YAPILAN VİRAL ETKEN İNCELEME SAYISI";
$rotabaslik="Rota Virüs (A08.0)";
$norobaslik="Noro Virüs (A08.1)";
$adenobaslik="Adeno Virüs (A08.2)";
$hepabaslik="Hepatit A Virüsü (B15)";
$duzbaslik="DÜZENLEYEN";
...
$hastverigirilmedi="Henüz Hastanelere ait veri girilmemiştir.";
$hastveriyok="Hastaneye ait veriler girilmemiştir.";
$hastveritamam="Bütün Hastanelere ait veri girişi yapılmıştır.";
$ahveriyok="Aile hekimlerine ait veri girişi yoktur.";
...
$degistirilmedi="Verileriniz Değitirilemedi...";
