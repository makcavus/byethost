...
if($ocgelen=="" or substr($ocgelen,-9)=="Hastanesi"){
	...
	$ahb=trsuz("Aile Hekimliği Birimi");
	}
if(substr($ocgelen,-3)=="TSM"){
	$kurum=$asmninadine ;
	}else{	
...
$pdf->MultiCell(80,4,$ilinadi.'-'.$ilceninadi,0,'L');

$pdf->SetY(24);
$pdf->SetX(15);
$pdf->Cell(25,4,trsuz('Kurum:'),0,0,'L',1);
$pdf->MultiCell(80,4,$kurum,0,'L');

$pdf->SetY(28);
$pdf->SetX(15);
$pdf->Cell(25,4,trsuz('Dönem/Tarih:'),0,0,'L',1);
$pdf->MultiCell(80,4,$yilgelen.' '.trsuz('YILI').' '.$aygelen.' '.trsuz('AYI'),0,'L');
