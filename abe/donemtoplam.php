...
$ahkodum=$ahkod.' '.$ahno;
	   ...
	   if($ilcegelen==$ilcesecim or $secim=="ilsec"){
$ililce=$ilinadi;
$kurum="İL TOPLAMI";
$top="İL TOPLAMI";
}elseif($ocgelen==$ahsecim  or $secim=="ilcesec"){
...
}elseif($ilcegelen!=$ilcesecim and $ocgelen!=$ahsecim  or $secim=="aheksec"){
$ililce=$ilinadi.'-'.$ilceninadi;
...
<?php
echo '<form action="donempdf.php" method="get" name="gor" target="hoppa" onSubmit="hoppa()">' ;
...
echo '<form action="topgrafikdonem.php" method="get" name="gor" target="hoppa" onSubmit="hoppa()">';
echo '<input type="hidden" name="selectil" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="'.$ilgelen.'" />';
echo '<input type="hidden" name="selectilce" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="'.$ilcegelen.'" />';
echo '<input type="hidden" name="selectoc" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="'.$ocgelen.'" />';
echo '<input type="hidden" name="selectyil" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="'.$yilgelen.'" />';
...
echo '</form>';
?></th>
<th class="style6" width="52%" align="center" bordercolor="#FFCC00" bgcolor="blue"><font size="4" color="yellow"><?php echo trsuz($donemgorbaslik); ?></font></th>
<th class="style6" width="12%"align="right" bordercolor="#FFCC00" bgcolor="#FFCC00">
<?php
echo '<form action="grafikdonem.php" method="get" name="gor" target="hoppa" onSubmit="hoppa()">';
echo '<input type="hidden" name="selectil" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="'.$ilgelen.'" />';
echo '<input type="hidden" name="selectilce" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="'.$ilcegelen.'" />';
echo '<input type="hidden" name="selectoc" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="'.$ocgelen.'" />';
echo '<input type="hidden" name="selectyil" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="'.$yilgelen.'" />';
...
echo '<form action="/excelmysql/abedonemxls.php" method="get" name="gor">' ;
...
echo '<input type="hidden" name="selectoc" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="'.trsuz($ocgelenx).'" />';
echo '<input type="hidden" name="selectyil" width="0" height="0" vspace="0" hspace="0" border="0" size="0" value="'.$yilgelen.'" />';
...
<tr>
    <th width="27%" align="center"bordercolor="#000000" bgcolor="white" class="style5"><? $top=$iltopbaslik; echo '<font size="3" family="Arial"><label>'.trsuz($kurum).' '.$yilgelen.'-'.trsuz($donemi).'</label></font>' ; ?></th>
</tr>
</TABLE>
<br>
<table class="cizgi" border="0" bordercolor="#FFFFFF" align="center" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
    ...
    <th  width="88%"align="left" bordercolor="white" colspan="11"><? $periyod="(ÜÇ AYLIK)"; echo '<font size="3" family="Arial">'.$yilgelen.'-'.trsuz($donemi).' '.trsuz($periyod).'</font>' ;?></th>
  </tr>
  <tr>
    <th  width="100%"align="center" bordercolor="white" colspan="12">&nbsp;</th>
  </tr>
