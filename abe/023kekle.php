...
echo '<label>'.trsuz($kayiteklendi).'</label><a href="#" onClick="kontrol();">'.trsuz($geridon).'</a>';
}else{
echo '<label><font style="color:Red">Verileriniz Kaydedilemedi...</font></label><meta http-equiv=refresh content="100; url=http://localhost/form023/frm023kayit.php" /><a href="http://malika.byethost12.com/abe/frm023kayit.php" _fcksavedurl="http://localhost/form023/frm023kayit.php">Tekrar deneyiniz.</a>';
echo mysql_error();
 }
}else{ echo '<label><font style="color:Red">Bu Kayıt Daha Önce Yapılmış...</font></label><meta http-equiv=refresh content="100; url=http://localhost/form023/frm023kayit.php" /><a href="http://malika.byethost12.com/abe/frm023kayit.php" _fcksavedurl="http://localhost/form023/frm023kayit.php">'.trsuz($geridon).'</a>';
echo'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
?>
<?php
