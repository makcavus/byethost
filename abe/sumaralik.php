...
$tarihilk=$aygelentarihyil.'-'.$aygelentarihay.'-'.$aygelentarihgun;
...
$tarihson=$aygelentarihyil.'-'.$aygelentarihay.'-'.$aygelentarihgun;
...
from veri where ilidi='$ilgelen' and (vayadi between '$tarihilk' and '$tarihson')") ;
...
from veri where ilidi='$ilgelen' and ilceidi='$ilcegelen' and  (vayadi between '$tarihilk' and '$tarihson')") ;
...
from veri where ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelenx' and  (vayadi between '$tarihilk' and '$tarihson')") ;

}elseif($ilcegelen==trsuz($ilcesecim) and $yilgelen==""){
...
}elseif($ocgelen==trsuz($ahsecim)and $yilgelen==""){
...
}elseif($ilcegelen!=trsuz($ilcesecim) and $ocgelen!=trsuz($ahsecim) and $yilgelen==""){
...
from veri where ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and (vayadi between '$tarihilk' and '$tarihson')") ;
