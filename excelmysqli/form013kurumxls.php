...
->setCellValue('B4', mb_convert_encoding ($socadi, "UTF-8", "ISO-8859-9" ))
...
//KPA
$kpa1top=$tverim19+$tverim20+$tverim21+$tverim142;
...
->setCellValue('B2', mb_convert_encoding ($ilinadi, "UTF-8", "ISO-8859-9" ))
->setCellValue('B3', mb_convert_encoding ($ilceninadi, "UTF-8", "ISO-8859-9" ))
->setCellValue('B4', mb_convert_encoding ($hangi, "UTF-8", "ISO-8859-9" ))
->setCellValue('K2', $yilgelen)
