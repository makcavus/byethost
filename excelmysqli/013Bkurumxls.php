...
from verib where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen') group by vayadi order by vayadi desc") or die (mysql_error()) ;
...
->setCellValue('C6', mb_convert_encoding ($socadi, "UTF-8", "ISO-8859-9" ))
...
$objPHPExcel->getSheet(1)->setTitle(mb_convert_encoding ($ayadi, "UTF-8", "ISO-8859-9" ));
...
->setCellValue('C6', mb_convert_encoding ($hangi, "UTF-8", "ISO-8859-9" ))
...
$objPHPExcel->getActiveSheet(0)->setTitle(mb_convert_encoding ($hangi, "UTF-8", "ISO-8859-9" ));
