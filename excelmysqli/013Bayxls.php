...
->setCellValue('B4', mb_convert_encoding ($ilinadi, "UTF-8", "ISO-8859-9" ))
->setCellValue('B5', mb_convert_encoding ($ilceninadi, "UTF-8", "ISO-8859-9" ))
->setCellValue('C6', mb_convert_encoding ($top, "UTF-8", "ISO-8859-9" ))
->setCellValue('I5', $yilgelen)
->setCellValue('I6', mb_convert_encoding ($ayadi, "UTF-8", "ISO-8859-9" ))
...
//DÜZENLEYEN-ONAYLAYAN			 
			->setCellValue('A40', mb_convert_encoding ($verim173, "UTF-8", "ISO-8859-9" ))
			 
			->setCellValue('A41', mb_convert_encoding ($verim174, "UTF-8", "ISO-8859-9" ))
			 
			->setCellValue('G40', mb_convert_encoding ($verim176, "UTF-8", "ISO-8859-9" ))		 

			->setCellValue('G41', mb_convert_encoding ($verim177, "UTF-8", "ISO-8859-9" ))
...
$objPHPExcel->getSheet($i)->getColumnDimension($col)->setWidth(12);

}

$objPHPExcel->getSheet($i)->getColumnDimension('I')->setWidth(14);

//$objPHPExcel->getSheet($i)->getStyle('A1')->getFont()->getColor()->setARGB(PHPExcel_Style_Color::COLOR_RED);

$objPHPExcel->getSheet($i)->getStyle('F10:H14')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID);

$objPHPExcel->getSheet($i)->getStyle('F10:H14')->getFill()->getStartColor()->setARGB('# bebebe');

$objPHPExcel->getSheet($i)->getStyle('C13')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID);

$objPHPExcel->getSheet($i)->getStyle('C13')->getFill()->getStartColor()->setARGB('# bebebe');

$objPHPExcel->getSheet($i)->getStyle('C14:F14')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID);

$objPHPExcel->getSheet($i)->getStyle('C14:F14')->getFill()->getStartColor()->setARGB('# bebebe');
...
$objPHPExcel->getSheet($i)->getRowDimension('2')->setRowHeight(15);
$objPHPExcel->getSheet($i)->getRowDimension('3')->setRowHeight(15);
$objPHPExcel->getSheet($i)->getRowDimension('4')->setRowHeight(15);
$objPHPExcel->getSheet($i)->getRowDimension('5')->setRowHeight(15);
$objPHPExcel->getSheet($i)->getRowDimension('6')->setRowHeight(15);
$objPHPExcel->getSheet($i)->getRowDimension('7')->setRowHeight(15);
$objPHPExcel->getSheet($i)->getRowDimension('8')->setRowHeight(15);
$objPHPExcel->getSheet($i)->getRowDimension('9')->setRowHeight(30);
$objPHPExcel->getSheet($i)->getRowDimension('10')->setRowHeight(24);
$objPHPExcel->getSheet($i)->getRowDimension('11')->setRowHeight(24);
$objPHPExcel->getSheet($i)->getRowDimension('12')->setRowHeight(24);
$objPHPExcel->getSheet($i)->getRowDimension('13')->setRowHeight(24);
$objPHPExcel->getSheet($i)->getRowDimension('14')->setRowHeight(24);
$objPHPExcel->getSheet($i)->getRowDimension('16')->setRowHeight(24);
$objPHPExcel->getSheet($i)->getRowDimension('17')->setRowHeight(24);
$objPHPExcel->getSheet($i)->getRowDimension('18')->setRowHeight(24);
$objPHPExcel->getSheet($i)->getRowDimension('19')->setRowHeight(24);
$objPHPExcel->getSheet($i)->getRowDimension('20')->setRowHeight(24);
$objPHPExcel->getSheet($i)->getRowDimension('22')->setRowHeight(24);
$objPHPExcel->getSheet($i)->getRowDimension('23')->setRowHeight(24);
$objPHPExcel->getSheet($i)->getRowDimension('24')->setRowHeight(24);
$objPHPExcel->getSheet($i)->getRowDimension('26')->setRowHeight(24);
$objPHPExcel->getSheet($i)->getRowDimension('27')->setRowHeight(24);
$objPHPExcel->getSheet($i)->getRowDimension('28')->setRowHeight(24);
$objPHPExcel->getSheet($i)->getRowDimension('29')->setRowHeight(24);
$objPHPExcel->getSheet($i)->getRowDimension('31')->setRowHeight(24);
$objPHPExcel->getSheet($i)->getRowDimension('32')->setRowHeight(24);
$objPHPExcel->getSheet($i)->getRowDimension('33')->setRowHeight(24);
$objPHPExcel->getSheet($i)->getRowDimension('35')->setRowHeight(24);
...
$objPHPExcel->getSheet($i)->getRowDimension('41')->setRowHeight(15);


$objPHPExcel->getSheet($i)->getStyle('A1:I46')->getAlignment()->setWrapText(true);

$objPHPExcel->getSheet($i)->getStyle('A8:I46')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);

$objPHPExcel->getSheet($i)->getStyle('A8:I46')->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);

$objPHPExcel->getSheet($i)->mergeCells("A2:I2");
$objPHPExcel->getSheet($i)->mergeCells("A6:B6");


$objPHPExcel->getActiveSheet($i)->getStyle('A2:I35')->getFont()->setBold(true);
$objPHPExcel->getActiveSheet(0)->getStyle('A2')->getAlignment()->applyFromArray(
			array(
	 			'horizontal' => PHPExcel_Style_Alignment::HORIZONTAL_CENTER,
				'vertical'   => PHPExcel_Style_Alignment::VERTICAL_CENTER,
...
$objPHPExcel->getSheet($i)->mergeCells("B4:D4");
$objPHPExcel->getSheet($i)->mergeCells("B5:D5");
$objPHPExcel->getSheet($i)->mergeCells("C6:D6");
$objPHPExcel->getActiveSheet(0)->getStyle('I4:I6')->getAlignment()->applyFromArray(
			array(
	 			'horizontal' => PHPExcel_Style_Alignment::HORIZONTAL_LEFT,
				'vertical'   => PHPExcel_Style_Alignment::VERTICAL_CENTER,
...
$objPHPExcel->getSheet($i)->setCellValue('A2', 'ÖZEL HEKİM AŞI UYGULAMALARI   (FORM 013B)');

$objPHPExcel->getSheet($i)->setCellValue('A4', 'İL:');

$objPHPExcel->getSheet($i)->setCellValue('A5', 'İLÇE:');

$objPHPExcel->getSheet($i)->setCellValue('A6','AİLE HEKİMİNİN KODU:');
...
$objPHPExcel->getActiveSheet($i)->getColumnDimension($col)->setWidth(15);

$objPHPExcel->getSheet($i)->setCellValue('H5','YIL:');

$objPHPExcel->getSheet($i)->setCellValue('H6','AY:');

$objPHPExcel->getSheet($i)->setCellValue('A8','');

$objPHPExcel->getSheet($i)->mergeCells("B8:I8");

$objPHPExcel->getSheet($i)->getStyle('A8:I46')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);

$objPHPExcel->getSheet($i)->getStyle('A8:I46')->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);

$objPHPExcel->setActiveSheetIndex($i)->getStyle("A8:I14")->applyFromArray($styleThinBlackBorderOutline);

$objPHPExcel->setActiveSheetIndex($i)->getStyle("A8:I14")->applyFromArray($ciftcizgi);

$objPHPExcel->getSheet($i)->setCellValue('B8','YAŞ GRUPLARINA GÖRE YAPILAN DOZ SAYISI');



$objPHPExcel->getSheet($i)->setCellValue('A9','AŞI');

$objPHPExcel->getSheet($i)->setCellValue('B10','I');

$objPHPExcel->getSheet($i)->setCellValue('B11','II');

$objPHPExcel->getSheet($i)->setCellValue('B12','III');

$objPHPExcel->getSheet($i)->setCellValue('B13','R');

$objPHPExcel->getSheet($i)->mergeCells("A10:A13");

$objPHPExcel->getSheet($i)->setCellValue('B9','Uygu- lama');

$objPHPExcel->getSheet($i)->setCellValue('C9','0 yaş              (0-11 ay)');

$objPHPExcel->getSheet($i)->setCellValue('D9','1 yaş              (12-23 ay)');

$objPHPExcel->getSheet($i)->setCellValue('E9','2-4 yaş            (24-59 ay)');

$objPHPExcel->getSheet($i)->setCellValue('F9','5-9 yaş');

$objPHPExcel->getSheet($i)->setCellValue('G9','10-14 yaş');

$objPHPExcel->getSheet($i)->setCellValue('H9','15 yaş ve üzeri');

$objPHPExcel->getSheet($i)->setCellValue('I9','TOPLAM');

$objPHPExcel->getSheet($i)->mergeCells("A14:B14");

$objPHPExcel->getSheet($i)->setCellValue('A10','DaBT-IPA-Hib AŞISI');

$objPHPExcel->getSheet($i)->setCellValue('A14','TOPLAM');

$objPHPExcel->getSheet($i)->getRowDimension('15')->setRowHeight(12);

$objPHPExcel->setActiveSheetIndex($i)->getStyle("A16:I16")->applyFromArray($styleThinBlackBorderOutline);

$objPHPExcel->setActiveSheetIndex($i)->getStyle("A16:I16")->applyFromArray($ciftcizgi);


//KONJUGE PNOMOKOK AŞISI


$objPHPExcel->setActiveSheetIndex($i)->getStyle("A16:I20")->applyFromArray($styleThinBlackBorderOutline);

$objPHPExcel->setActiveSheetIndex($i)->getStyle("A16:I20")->applyFromArray($ciftcizgi);
...
$objPHPExcel->getSheet($i)->setCellValue('A20','TOPLAM');
...
$objPHPExcel->getSheet($i)->getRowDimension('21')->setRowHeight(12);

$objPHPExcel->setActiveSheetIndex($i)->getStyle("A22:I24")->applyFromArray($styleThinBlackBorderOutline);

$objPHPExcel->setActiveSheetIndex($i)->getStyle("A22:I24")->applyFromArray($ciftcizgi);

$objPHPExcel->getSheet($i)->mergeCells("A22:A23");

$objPHPExcel->getSheet($i)->setCellValue('A22','K.K.K. AŞISI');

$objPHPExcel->getSheet($i)->mergeCells("A24:B24");

$objPHPExcel->getSheet($i)->setCellValue('A24','TOPLAM');

$objPHPExcel->getSheet($i)->setCellValue('B22','I');

$objPHPExcel->getSheet($i)->setCellValue('B23','R');

$objPHPExcel->getSheet($i)->getStyle('C22:C24')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID);

$objPHPExcel->getSheet($i)->getStyle('C22:C24')->getFill()->getStartColor()->setARGB('# bebebe');

$objPHPExcel->getSheet($i)->getStyle('C24:H24')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID);

$objPHPExcel->getSheet($i)->getStyle('C24:H24')->getFill()->getStartColor()->setARGB('# bebebe');


//HEPATİT B AŞISI
$objPHPExcel->getSheet($i)->getRowDimension('25')->setRowHeight(12);

$objPHPExcel->setActiveSheetIndex($i)->getStyle("A26:I29")->applyFromArray($styleThinBlackBorderOutline);

$objPHPExcel->setActiveSheetIndex($i)->getStyle("A26:I29")->applyFromArray($ciftcizgi);

$objPHPExcel->getSheet($i)->mergeCells("A26:A28");

$objPHPExcel->getSheet($i)->setCellValue('A26','  HEPATİT-B   AŞISI');

$objPHPExcel->getSheet($i)->mergeCells("A29:B29");

$objPHPExcel->getSheet($i)->setCellValue('A29','TOPLAM');

$objPHPExcel->getSheet($i)->setCellValue('B26','I');

$objPHPExcel->getSheet($i)->setCellValue('B27','II');

$objPHPExcel->getSheet($i)->setCellValue('B28','III');

$objPHPExcel->getSheet($i)->getStyle('C29:H29')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID);

$objPHPExcel->getSheet($i)->getStyle('C29:H29')->getFill()->getStartColor()->setARGB('# bebebe');

//HEPATİT A AŞISI

$objPHPExcel->getSheet($i)->getRowDimension('30')->setRowHeight(12);

$objPHPExcel->setActiveSheetIndex($i)->getStyle("A31:I33")->applyFromArray($styleThinBlackBorderOutline);

$objPHPExcel->setActiveSheetIndex($i)->getStyle("A31:I33")->applyFromArray($ciftcizgi);

$objPHPExcel->getSheet($i)->mergeCells("A31:A32");

$objPHPExcel->getSheet($i)->setCellValue('A31','HEPATİT A AŞISI');

$objPHPExcel->getSheet($i)->mergeCells("A33:B33");

$objPHPExcel->getSheet($i)->setCellValue('A33','TOPLAM');

$objPHPExcel->getSheet($i)->setCellValue('B31','I');

$objPHPExcel->getSheet($i)->setCellValue('B32','II');

$objPHPExcel->getSheet($i)->getStyle('C31:C33')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID);

$objPHPExcel->getSheet($i)->getStyle('C31:C33')->getFill()->getStartColor()->setARGB('# bebebe');

$objPHPExcel->getSheet($i)->getStyle('C33:H33')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID);

$objPHPExcel->getSheet($i)->getStyle('C33:H33')->getFill()->getStartColor()->setARGB('# bebebe');

//SU ÇİÇEĞİ AŞISI

$objPHPExcel->getSheet($i)->getRowDimension('34')->setRowHeight(12);

$objPHPExcel->setActiveSheetIndex($i)->getStyle("A35")->getFont()->setName('Arial')->setSize(10);

$objPHPExcel->getSheet($i)->setCellValue('A35','SUÇİÇEĞİ AŞISI');

$objPHPExcel->getSheet($i)->setCellValue('B35','');

$objPHPExcel->setActiveSheetIndex($i)->getStyle("A35:I35")->applyFromArray($styleThinBlackBorderOutline);

$objPHPExcel->setActiveSheetIndex($i)->getStyle("A35:I35")->applyFromArray($ciftcizgi);

$objPHPExcel->getSheet($i)->getStyle('C35')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID);

$objPHPExcel->getSheet($i)->getStyle('C35')->getFill()->getStartColor()->setARGB('# bebebe');

//AÇIKLAMALAR
$objPHPExcel->getSheet($i)->getRowDimension('36')->setRowHeight(15);
$objPHPExcel->getActiveSheet($i)->getStyle('A37:A37')->getAlignment()->applyFromArray(
			array(
	 			'horizontal' => PHPExcel_Style_Alignment::HORIZONTAL_LEFT,
				'vertical'   => PHPExcel_Style_Alignment::VERTICAL_CENTER,
	 			'rotation'   => 0,
...
$objPHPExcel->setActiveSheetIndex($i)->getStyle("A37:A37")->getFont()->setName('Arial')->setSize(10);
	  
$objPHPExcel->getSheet($i)->mergeCells("A37:I37");

$objPHPExcel->getSheet($i)->setCellValue('A37','*Özel hekimler tarafından eczanelerden temin edilerek uygulanan aşılar bu forma kaydedilecek');

$objPHPExcel->getSheet($i)->getRowDimension('38')->setRowHeight(15);

$objPHPExcel->getActiveSheet($i)->getStyle('A39:I46')->getFont()->setBold(true);

$objPHPExcel->getSheet($i)->mergeCells("A39:C39");
$objPHPExcel->getSheet($i)->mergeCells("G39:I39");
$objPHPExcel->getSheet($i)->setCellValue('A39','FORMU DÜZENLEYEN');
$objPHPExcel->getSheet($i)->setCellValue('G39','FORMU ONAYLAYAN');
$objPHPExcel->getSheet($i)->mergeCells("A40:C40");
$objPHPExcel->getSheet($i)->mergeCells("G40:I40");
$objPHPExcel->getSheet($i)->mergeCells("A41:C41");
$objPHPExcel->getSheet($i)->mergeCells("G41:I41");
...
->setCellValue('B4', mb_convert_encoding ($ilinadi, "UTF-8", "ISO-8859-9" ))
->setCellValue('B5', mb_convert_encoding ($ilceninadi, "UTF-8", "ISO-8859-9" ))
->setCellValue('C6', mb_convert_encoding ('', "UTF-8", "ISO-8859-9" ))
->setCellValue('I5', $yilgelen)
->setCellValue('I6', mb_convert_encoding ($ayadi, "UTF-8", "ISO-8859-9" ))
...
//DÜZENLEYEN-ONAYLAYAN			 
			->setCellValue('A40', mb_convert_encoding ('', "UTF-8", "ISO-8859-9" ))
			 
			->setCellValue('A41', mb_convert_encoding ('', "UTF-8", "ISO-8859-9" ))
			 
			->setCellValue('G40', mb_convert_encoding ('', "UTF-8", "ISO-8859-9" ))		 

			->setCellValue('G41', mb_convert_encoding ('', "UTF-8", "ISO-8859-9" ));		 
...
//DBT
$xdbt1top=$tverim1+$tverim2+$tverim3+$tverim4;
$xdbt2top=$tverim5+$tverim6+$tverim7+$tverim8;
$xdbt3top=$tverim9+$tverim10+$tverim11+$tverim12;
$xdbtraptop=$tverim13+$tverim14+$tverim15;
$xtoplamdbt=$xdbt1top+$xdbt2top+$xdbt3top+$xdbtraptop;
//KPA
$xkpa1top=$tverim16+$tverim17+$tverim18+$tverim19+$tverim20+$tverim21;
$xkpa2top=$tverim22+$tverim23+$tverim24+$tverim25+$tverim26+$tverim27;
$xkpa3top=$tverim28+$tverim29+$tverim30+$tverim31+$tverim32+$tverim33;
$xkparaptop=$tverim34+$tverim35+$tverim36+$tverim37+$tverim38;
$xtoplamkpa=$xkpa1top+$xkpa2top+$xkpa3top+$xkparaptop;
//KKK
$xkkk1top=$tverim39+$tverim40+$tverim41+$tverim42+$tverim43;
$xkkkraptop=$tverim44+$tverim45+$tverim46+$tverim47+$tverim48;
$xtoplamkkk=$xkkk1top+$xkkkraptop;
//HEPATİT-B
$xtoplamhep1=$tverim49+$tverim50+$tverim51+$tverim52+$tverim53+$tverim54;
$xtoplamhep2=$tverim55+$tverim56+$tverim57+$tverim58+$tverim59+$tverim60;
$xtoplamhep3=$tverim61+$tverim62+$tverim63+$tverim64+$tverim65+$tverim66;
$xtoplamhep=$xtoplamhep1+$xtoplamhep2+$xtoplamhep3;
//HEPATİT-A
$xhepa1top=$tverim67+$tverim68+$tverim69+$tverim70+$tverim71;
$xheparaptop=$tverim72+$tverim73+$tverim74+$tverim75+$tverim76;
$xtoplamhepa=$xhepa1top+$xheparaptop;
//SU ÇİÇEĞİ
$xsuctop=$tverim77+$tverim78+$tverim79+$tverim80+$tverim81;
...
->setCellValue('B4', mb_convert_encoding ($ilinadi, "UTF-8", "ISO-8859-9" ))
->setCellValue('B5', mb_convert_encoding ($kurumt, "UTF-8", "ISO-8859-9" ))
->setCellValue('C6', mb_convert_encoding ($top, "UTF-8", "ISO-8859-9" ))
->setCellValue('I5', $yilgelen)
->setCellValue('I6', mb_convert_encoding ($ayadi, "UTF-8", "ISO-8859-9" ))
