...
$aygelentarihgun=substr($tarihilkal,0,2);
$aygelentarihay=substr($tarihilkal,3,2);
$aygelentarihyil=substr($tarihilkal,6,4);
$aygelenx=$aygelentarihyil.'-'.$aygelentarihay.'-'.$aygelentarihgun;

$aygelentarihgun=substr($tarihsonal,0,2);
$aygelentarihay=substr($tarihsonal,3,2);
$aygelentarihyil=substr($tarihsonal,6,4);
$aygeleny=$aygelentarihyil.'-'.$aygelentarihay.'-'.$aygelentarihgun;
//include('sumay.php');
$aytoplami=trsuz('TARİHLERİ ARASI TOPLAMI');
...
$atarih=mysql_query("SELECT date_format(v175, '%d.%m.%Y')  AS yeni_tarih FROM veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen')") ;
while($duztarih=mysql_fetch_array($atarih)){
$dtarih=$duztarih['yeni_tarih'];
}
$btarih=mysql_query("SELECT date_format(v178, '%d.%m.%Y')  AS yeni_tarih FROM veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen')") ;
...
v177 as v177,
v178 as v178
from veri where ilidi='$ilgelen' and (vayadi between '$aygelenx' and '$aygeleny') group by ilceidi order by ilceidi desc") ;
...
v177 as v177,
v178 as v178
from veri where ilidi='$ilgelen' and ilceidi='$ilcegelen' and (vayadi between '$aygelenx' and '$aygeleny') group by vocadi order by vocadi desc") ;
...
v177 as v177,
v178 as v178
from veri where ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and (vayadi between '$aygelenx' and '$aygeleny') group by vocadi order by vocadi desc")  or die(mysql_error()) ;
}else{
$resultvyil = @mysql_query("select  ilceidi as iii,vocadi as vvv,vayadi as vayadi,
sum(v1) as v1,
sum(v2) as v2, 
...
v177 as v177,
v178 as v178
from veri where ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and (vayadi between '$aygelenx' and '$aygeleny') order by desc") ;
}
...
if($ilcegelen==trsuz("İlçe Seçiniz") and substr($socadi,3,1)=="."){
...
}elseif($ocgelen==trsuz("Aile Hekimini Seçiniz") and substr($socadi,3,1)=="."){
$ilkod=trsuz(substr(trim($socadi),0,2));
$ilcekod=trsuz(substr(trim($socadi),3,2));
...
}elseif($ilcegelen!=trsuz("İlçe Seçiniz") and $ocgelen!=trsuz("Aile Hekimini Seçiniz") and substr($socadi,3,1)=="."){
...
$atarih=mysql_query("SELECT date_format(v175, '%d.%m.%Y')  AS yeni_tarih FROM veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen')") ;
while($duztarih=mysql_fetch_array($atarih)){
$dtarih=$duztarih['yeni_tarih'];
}
$btarih=mysql_query("SELECT date_format(v178, '%d.%m.%Y')  AS yeni_tarih FROM veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen')") ;
while($ontarih=mysql_fetch_array($btarih)){
$otarih=$ontarih['yeni_tarih'];
}
...
$yili=$tarihilkal.'-'.$tarihsonal.' '.$aytoplami;
...
$objPHPExcel->getSheet(1)->setTitle(mb_convert_encoding ($kurumad, "UTF-8", "ISO-8859-9" ));
...
sum(v171) as v171,
sum(v172) as v172
from veri where ilidi='$ilgelen' and (vayadi between '$aygelenx' and '$aygeleny') order by ilceidi desc") ;
}elseif($ocgelen==trsuz("Aile Hekimini Seçiniz")){
$tresultvyil = @mysql_query("select
sum(v1) as v1,
sum(v2) as v2, 
...
from veri where ilidi='$ilgelen' and ilceidi='$ilcegelen' and (vayadi between '$aygelenx' and '$aygeleny') order by vocadi desc") ;
}elseif($ilcegelen!=trsuz("İlçe Seçiniz") and $ocgelen!=trsuz("Aile Hekimini Seçiniz")){
$tresultvyil = @mysql_query("select
sum(v1) as v1,
sum(v2) as v2, 
...
from veri where ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and (vayadi between '$aygelenx' and '$aygeleny')") ;
}else{
$tresultvyil = @mysql_query("select
sum(v1) as v1,
sum(v2) as v2, 
...
$tresultvyil = @mysql_query("select v173 as v173,v174 as v174,v176 as v176,v177 as v177 from veri where ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and (vayadi between '$aygelenx' and '$aygeleny')") ;
while($sonucum=mysql_fetch_array($tresultvyil)){
