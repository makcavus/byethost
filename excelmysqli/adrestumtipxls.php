...
$ilcesorgu=@mysqli_query($dbh,"select * from $form013_db_name.ilce where(ilinad='$iladi' and ilceid='$ilceadi')");
...
header('Content-Disposition: attachment;filename="Tüm_Adres_Tipleri.xls"');
