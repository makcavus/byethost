...
v177 as v177,
v178 as v178
from veri where ilidi='$ilgelen' and vyiladi='$yilgelen' and (vayadi between '$aygelenx' and '$aygeleny') group by ilceidi order by ilceidi desc") ;
...
v177 as v177,
v178 as v178
from veri where ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi='$yilgelen' and (vayadi between '$aygelenx' and '$aygeleny') group by vocadi order by vocadi desc") ;
...
v177 as v177,
v178 as v178
from veri where ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and (vayadi between '$aygelenx' and '$aygeleny') group by vayadi order by vayadi desc")  or die(mysql_error()) ;
}else{
$resultvyil = @mysql_query("select  ilceidi as iii,vocadi as vvv,vayadi as vayadi,
sum(v1) as v1,
sum(v2) as v2, 
...
v177 as v177,
v178 as v178
from veri where ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and (vayadi between '$aygelenx' and '$aygeleny') order by desc") ;
}
...
sum(v171) as v171,
sum(v172) as v172
from veri where ilidi='$ilgelen' and vyiladi='$yilgelen' and (vayadi between '$aygelenx' and '$aygeleny') order by ilceidi desc") ;
}elseif($ocgelen==trsuz("Aile Hekimini Seçiniz")){
$tresultvyil = @mysql_query("select
sum(v1) as v1,
sum(v2) as v2, 
...
from veri where ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi='$yilgelen' and (vayadi between '$aygelenx' and '$aygeleny') order by vocadi desc") ;
}elseif($ilcegelen!=trsuz("İlçe Seçiniz") and $ocgelen!=trsuz("Aile Hekimini Seçiniz")){
$tresultvyil = @mysql_query("select
sum(v1) as v1,
sum(v2) as v2, 
