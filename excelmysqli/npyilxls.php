...
$atarih=mysql_query("SELECT date_format(v175, '%d.%m.%Y')  AS yeni_tarih from yg where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi='$yilgelen')") ;
while($duztarih=mysql_fetch_array($atarih)){
$dtarih=$duztarih['yeni_tarih'];
}
$btarih=mysql_query("SELECT date_format(v178, '%d.%m.%Y')  AS yeni_tarih from yg where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi='$yilgelen')") ;
while($ontarih=mysql_fetch_array($btarih)){
$otarih=$ontarih['yeni_tarih'];
}

if($ilcegelen=="İlçe Seçiniz"){
$resultvyil = @mysql_query("select ilceidi as iii,vocadi as vvv, vyiladi as vyiladi,
sum(v1) as v1,
sum(v2) as v2, 
sum(v3) as v3,
sum(v4) as v4, 
...
sum(v59) as v59,
sum(v60) as v60
from yg where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi='$yilgelen') group by vocadi order by vocadi desc") ;
...
sum(v59) as v59,
sum(v60) as v60
from yg where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen') group by vocadi order by vocadi desc")  or die(mysql_error()) ;
}else{
$resultvyil = @mysql_query("select  ilceidi as iii,vocadi as vvv,vyiladi as vyiladi,
sum(v1) as v1,
sum(v2) as v2, 
...
sum(v59) as v59,
sum(v60) as v60
from yg where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen') order by desc") ;
}
...
->setCellValue('D2', mb_convert_encoding ($top, "UTF-8", "ISO-8859-9" ))
...
sum(v59) as v59,
sum(v60) as v60
from yg where(ilidi='$ilgelen' and vyiladi='$yilgelen') order by ilceidi desc") ;
}elseif($ocgelen=="Aile Hekimini Seçiniz"){
$tresultvyil = @mysql_query("select
sum(v1) as v1,
sum(v2) as v2, 
...
sum(v59) as v59,
sum(v60) as v60
from yg where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi='$yilgelen') order by vocadi desc") ;
}elseif($ilcegelen!="İlçe Seçiniz" and $ocgelen!="Aile Hekimini Seçiniz"){
$tresultvyil = @mysql_query("select
sum(v1) as v1,
sum(v2) as v2, 
...
$tresultvyil = @mysql_query("select v173 as v173,v174 as v174,v176 as v176,v177 as v177 from yg where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='$aygelen')") ;
while($sonucum=mysql_fetch_array($tresultvyil)){
...
header('Content-Disposition: attachment;filename="Nüfus_Verileri_Yil.xls"');
