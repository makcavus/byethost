...
$oncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vayadi='OCAK') group by vocadi order by vocadi asc") ;
}else{
$resultvyil = @mysql_query("select vocadi as vvv,
v1 as v1,
sum(v2) as v2, 
...
$oncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi='$yilgelen' and vayadi='$aygelen') group by vocadi order by vocadi asc") ;
}
...
//DÜZENLEYEN-ONAYLAYAN			 
			->setCellValue('F23', trsuz($verim173))
			 
			->setCellValue('F24', trsuz($verim174))
			 
			->setCellValue('J23', trsuz($verim176))		 

			->setCellValue('J24', trsuz($verim177));		 
...
$toncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vayadi='OCAK')") ;
}else{
$tresultvyil = @mysql_query("select 
sum(v1) as v1,
sum(v2) as v2, 
...
$toncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi='$yilgelen' and vayadi='$aygelen')") ;
}
