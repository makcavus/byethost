...
if($yilgelen==""){
$resultvyil = @mysql_query("select ilceidi as iii,vocadi as vvv,v176 as v176, 
sum(v2) as v2,sum(v4) as v4,sum(v5) as v5,sum(v6) as v6,sum(v7) as v7,sum(v8) as v8,sum(v9) as v9,sum(v10) as v10,sum(v11) as v11,sum(v12) as v12,sum(v13) as v13,sum(v14) as v14,sum(v15) as v15,sum(v16) as v16,sum(v17) as v17,sum(v18) as v18,sum(v19) as v19,sum(v20) as v20,sum(v21) as v21,sum(v22) as v22,
...
$oncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and vayadi='OCAK')") ;
...
$oncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and vyiladi='$yilgelen' and vayadi='MART') group by ilceidi order by ilceidi asc") ;

//$yer=$ilinadi;
//$toplam=trsuz('İL TOPLAMI');
//$nere=$yer.'-'.$toplam;
//ilçe ve 1 dönem seçili ise
...
$oncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and vyiladi='$yilgelen' and vayadi='MART') group by vocadi order by vocadi asc") ;


//$yer=$ilceninadi;
//$toplam=trsuz('İLÇE TOPLAMI');
//$nere=$yer.'-'.$toplam;

//A.Hekimi ve 1.dönem seçili ise
...
$oncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='MART') group by vocadi order by vocadi asc") ;

//$yer=$ocgelen;
//$toplam=trsuz('A.HEK. TOPLAMI');
//$nere=$yer.'-'.$toplam;

//il ve ikinci dönem seçili ise
...
$oncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and vyiladi='$yilgelen' and vayadi='$haziran') group by ilceidi order by ilceidi asc") ;

//$yer=$ilinadi;
//$toplam=trsuz('İL TOPLAMI');
//$nere=$yer.'-'.$toplam;

//ilçe ve 2 dönem seçili ise
...
$oncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and vyiladi='$yilgelen' and vayadi='$haziran') group by vocadi order by vocadi asc") ;

//$yer=$ilceninadi;
//$toplam=trsuz('İLÇE TOPLAMI');
//$nere=$yer.'-'.$toplam;

//A.Hekimi ve 2.dönem seçili ise
...
$oncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='$haziran')") ;

//$yer=$ocgelen;
//$toplam=trsuz('A.HEK. TOPLAMI');
//$nere=$yer.'-'.$toplam;

//il ve üçüncü dönem seçili ise
...
$oncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and vyiladi='$yilgelen' and vayadi='$eylul') group by ilceidi order by ilceidi asc") ;

//$yer=$ilinadi;
//$toplam=trsuz('İL TOPLAMI');
//$nere=$yer.'-'.$toplam;

//ilçe ve 3 dönem seçili ise
...
$oncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and vyiladi='$yilgelen' and vayadi='$eylul') group by vocadi order by vocadi asc") ;
...
//A.Hekimi ve 3.dönem seçili ise
...
$oncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='$eylul')") ;

//$yer=$ocgelen;
//$toplam=trsuz('A.HEK. TOPLAMI');
//$nere=$yer.'-'.$toplam;

//il ve dördüncü dönem seçili ise
...
$oncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and vyiladi='$yilgelen' and vayadi='ARALIK') group by ilceidi order by ilceidi asc") ;

//$yer=$ilinadi;
//$toplam=trsuz('İL TOPLAMI');
//$nere=$yer.'-'.$toplam;

//ilçe ve 4 dönem seçili ise
...
$oncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and vyiladi='$yilgelen' and vayadi='ARALIK') group by vocadi order by vocadi asc") ;

//$yer=$ilceninadi;
//$toplam=trsuz('İLÇE TOPLAMI');
//$nere=$yer.'-'.$toplam;

//A.Hekimi ve 4.dönem seçili ise
...
$oncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='ARALIK')") ;
...
$oncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and vyiladi='$yilgelen' and vayadi='OCAK')") ;

}
$row = 2;
//$row = mysql_num_rows($result);
//echo $rows;
while($sonucumx=mysql_fetch_array($oncekiadnks)){
...
sum(v148) as v148,sum(v149) as v149,sum(v150) as v150,sum(v151) as v151,sum(v152) as v152,sum(v153) as v153,sum(v154) as v154,sum(v155) as v155,sum(v156) as v156,sum(v157) as v157,sum(v158) as v158,sum(v159) as v159,sum(v160) as v160,sum(v161) as v161,sum(v162) as v162,sum(v163) as v163,sum(v164) as v164,sum(v165) as v165,
sum(v166) as v166,sum(v167) as v167,sum(v168) as v168,sum(v169) as v169,sum(v170) as v170,sum(v171) as v171,sum(v172) as v172
from veri where(ilidi='$ilgelen' and vyiladi='$yilgelen' and vayadi='OCAK' or vayadi='$subat' or vayadi='MART')") ;
$toncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and vyiladi='$yilgelen' and vayadi='MART')") ;
...
sum(v148) as v148,sum(v149) as v149,sum(v150) as v150,sum(v151) as v151,sum(v152) as v152,sum(v153) as v153,sum(v154) as v154,sum(v155) as v155,sum(v156) as v156,sum(v157) as v157,sum(v158) as v158,sum(v159) as v159,sum(v160) as v160,sum(v161) as v161,sum(v162) as v162,sum(v163) as v163,sum(v164) as v164,sum(v165) as v165,
sum(v166) as v166,sum(v167) as v167,sum(v168) as v168,sum(v169) as v169,sum(v170) as v170,sum(v171) as v171,sum(v172) as v172
from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi='$yilgelen' and vayadi='OCAK' or vayadi='$subat' or vayadi='MART')") ;
$toncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and vyiladi='$yilgelen' and vayadi='MART')") ;
...
$toncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='MART')") ;
...
sum(v166) as v166,sum(v167) as v167,sum(v168) as v168,sum(v169) as v169,sum(v170) as v170,sum(v171) as v171,sum(v172) as v172
from veri where(ilidi='$ilgelen' and vyiladi='$yilgelen' and vayadi='$nisan' or vayadi='MAYIS' or vayadi='$haziran')") ;
$toncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and vyiladi='$yilgelen' and vayadi='$haziran')") ;
...
sum(v148) as v148,sum(v149) as v149,sum(v150) as v150,sum(v151) as v151,sum(v152) as v152,sum(v153) as v153,sum(v154) as v154,sum(v155) as v155,sum(v156) as v156,sum(v157) as v157,sum(v158) as v158,sum(v159) as v159,sum(v160) as v160,sum(v161) as v161,sum(v162) as v162,sum(v163) as v163,sum(v164) as v164,sum(v165) as v165,
sum(v166) as v166,sum(v167) as v167,sum(v168) as v168,sum(v169) as v169,sum(v170) as v170,sum(v171) as v171,sum(v172) as v172
from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi='$yilgelen' and vayadi='$nisan' or vayadi='MAYIS' or vayadi='$haziran')") ;
$toncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and vyiladi='$yilgelen' and vayadi='$haziran')") ;
...
sum(v166) as v166,sum(v167) as v167,sum(v168) as v168,sum(v169) as v169,sum(v170) as v170,sum(v171) as v171,sum(v172) as v172
from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='$nisan' or ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='MAYIS' or ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='$haziran')") ;
$toncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='$haziran')") ;
...
sum(v148) as v148,sum(v149) as v149,sum(v150) as v150,sum(v151) as v151,sum(v152) as v152,sum(v153) as v153,sum(v154) as v154,sum(v155) as v155,sum(v156) as v156,sum(v157) as v157,sum(v158) as v158,sum(v159) as v159,sum(v160) as v160,sum(v161) as v161,sum(v162) as v162,sum(v163) as v163,sum(v164) as v164,sum(v165) as v165,
sum(v166) as v166,sum(v167) as v167,sum(v168) as v168,sum(v169) as v169,sum(v170) as v170,sum(v171) as v171,sum(v172) as v172
from veri where(ilidi='$ilgelen' and vyiladi='$yilgelen' and vayadi='TEMMUZ' or vayadi='$agustos' or vayadi='$eylul')") ;
$toncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and vyiladi='$yilgelen' and vayadi='$eylul')") ;
...
sum(v148) as v148,sum(v149) as v149,sum(v150) as v150,sum(v151) as v151,sum(v152) as v152,sum(v153) as v153,sum(v154) as v154,sum(v155) as v155,sum(v156) as v156,sum(v157) as v157,sum(v158) as v158,sum(v159) as v159,sum(v160) as v160,sum(v161) as v161,sum(v162) as v162,sum(v163) as v163,sum(v164) as v164,sum(v165) as v165,
sum(v166) as v166,sum(v167) as v167,sum(v168) as v168,sum(v169) as v169,sum(v170) as v170,sum(v171) as v171,sum(v172) as v172
from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi='$yilgelen' and vayadi='TEMMUZ' or vayadi='$agustos' or vayadi='$eylul')") ;
$toncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and vyiladi='$yilgelen' and vayadi='$eylul')") ;
...
sum(v166) as v166,sum(v167) as v167,sum(v168) as v168,sum(v169) as v169,sum(v170) as v170,sum(v171) as v171,sum(v172) as v172
from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='TEMMUZ' or ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='$agustos' or ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='$eylul')") ;
$toncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='$eylul')") ;
...
sum(v148) as v148,sum(v149) as v149,sum(v150) as v150,sum(v151) as v151,sum(v152) as v152,sum(v153) as v153,sum(v154) as v154,sum(v155) as v155,sum(v156) as v156,sum(v157) as v157,sum(v158) as v158,sum(v159) as v159,sum(v160) as v160,sum(v161) as v161,sum(v162) as v162,sum(v163) as v163,sum(v164) as v164,sum(v165) as v165,
sum(v166) as v166,sum(v167) as v167,sum(v168) as v168,sum(v169) as v169,sum(v170) as v170,sum(v171) as v171,sum(v172) as v172
from veri where(ilidi='$ilgelen' and vyiladi='$yilgelen' and vayadi='$ekim' or vayadi='KASIM' or vayadi='ARALIK')") ;
$toncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and vyiladi='$yilgelen' and vayadi='ARALIK')") ;
...
sum(v148) as v148,sum(v149) as v149,sum(v150) as v150,sum(v151) as v151,sum(v152) as v152,sum(v153) as v153,sum(v154) as v154,sum(v155) as v155,sum(v156) as v156,sum(v157) as v157,sum(v158) as v158,sum(v159) as v159,sum(v160) as v160,sum(v161) as v161,sum(v162) as v162,sum(v163) as v163,sum(v164) as v164,sum(v165) as v165,
sum(v166) as v166,sum(v167) as v167,sum(v168) as v168,sum(v169) as v169,sum(v170) as v170,sum(v171) as v171,sum(v172) as v172
from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi='$yilgelen' and vayadi='$ekim' or vayadi='KASIM' or vayadi='ARALIK')") ;
$toncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and vyiladi='$yilgelen' and vayadi='ARALIK')") ;
...
$oncekiadnks = @mysql_query("select * from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='ARALIK')") ;
$toncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='ARALIK')") ;
...
$toncekiadnks = @mysql_query("select sum(v1) as v1,sum(v3) as v3 from veri where(ilidi='$ilgelen' and vyiladi='$yilgelen' and vayadi='OCAK')") ;

}
while($sonucumx=mysql_fetch_array($toncekiadnks)){
...
$objPHPExcel->setActiveSheetIndex(1)->setCellValue('K'.$row,mb_convert_encoding ($kurum.' '.$yilgelen.'-'.$donemi, "UTF-8", "ISO-8859-9" ));
