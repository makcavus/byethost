...
echo trsuz(trsuz("İlçe Seçiniz"));

//echo "Aile Hekimini Se�iniz";
...
$atarih=mysql_query("SELECT date_format(v175, '%d.%m.%Y')  AS yeni_tarih FROM veris where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi='$yilgelen')") ;
while($duztarih=mysql_fetch_array($atarih)){
$dtarih=$duztarih['yeni_tarih'];
}
$btarih=mysql_query("SELECT date_format(v178, '%d.%m.%Y')  AS yeni_tarih FROM veris where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi='$yilgelen')") ;
...
v177 as v177,
v178 as v178
from veris where(ilidi='$ilgelen' and vyiladi='$yilgelen' and vayadi='$aygelen') group by ilceidi order by ilceidi desc") ;
...
v177 as v177,
v178 as v178
from veris where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi='$yilgelen' and vayadi='$aygelen') group by vocadi order by vocadi desc") ;
...
v177 as v177,
v178 as v178
from veris where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='$aygelen') group by vocadi order by vocadi desc")  or die(mysql_error()) ;
}else{
$resultvyil = @mysql_query("select  ilceidi as iii,vocadi as vvv,vayadi as vayadi,
sum(v1) as v1,
sum(v2) as v2, 
...
v177 as v177,
v178 as v178
from veris where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='$aygelen') order by desc") ;
}
...
$atarih=mysql_query("SELECT date_format(v175, '%d.%m.%Y')  AS yeni_tarih FROM veris where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen')") ;
while($duztarih=mysql_fetch_array($atarih)){
$dtarih=$duztarih['yeni_tarih'];
}
$btarih=mysql_query("SELECT date_format(v178, '%d.%m.%Y')  AS yeni_tarih FROM veris where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen')") ;
while($ontarih=mysql_fetch_array($btarih)){
$otarih=$ontarih['yeni_tarih'];
}
...
$objPHPExcel->getSheet(1)->setCellValue('A1', 'SURİYELİLER İÇİN AŞI SONUÇLARI ÇİZELGESİ   (FORM013)');
...
$objPHPExcel->getSheet($i)->setCellValue('A1', 'SURİYELİLER İÇİN AŞI SONUÇLARI ÇİZELGESİ   (FORM013)');
...
sum(v171) as v171,
sum(v172) as v172
from veris where(ilidi='$ilgelen' and vyiladi='$yilgelen' and vayadi='$aygelen') order by ilceidi desc") ;
}elseif($ocgelen==trsuz("Aile Hekimini Seçiniz")){
$tresultvyil = @mysql_query("select
sum(v1) as v1,
sum(v2) as v2, 
...
from veris where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi='$yilgelen' and vayadi='$aygelen') order by vocadi desc") ;
}elseif($ilcegelen!=trsuz("İlçe Seçiniz") and $ocgelen!=trsuz("Aile Hekimini Seçiniz")){
$tresultvyil = @mysql_query("select
sum(v1) as v1,
sum(v2) as v2, 
...
from veris where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='$aygelen')") ;
}else{
$tresultvyil = @mysql_query("select
sum(v1) as v1,
sum(v2) as v2, 
...
$tresultvyil = @mysql_query("select v173 as v173,v174 as v174,v176 as v176,v177 as v177 from veris where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='$aygelen')") ;
while($sonucum=mysql_fetch_array($tresultvyil)){
...
$objPHPExcel->getSheet(0)->setCellValue('A1', 'SURİYELİLER İÇİN AŞI SONUÇLARI ÇİZELGESİ   (FORM013)');
