...
$objWorkSheet = $objPHPExcel->createSheet($i); //Setting index when creating
	...
	include("sablonlar/form013/conf_bos_birimasitoplam.php");
    $i++;
    }
$iladi=@mysqli_query($dbh,"select * from il where(ilid='$ilgelen')");
while($ilsonucum=mysqli_fetch_array($iladi)){
...
while($sonucum=mysqli_fetch_array($tresultvyil)){
	...
	if($ilcegelen=="İlçe Seçiniz"){
		...
		$tresultvyil = @mysqli_query($dbh,"select v173 as v173,v174 as v174,v176 as v176,v177 as v177 from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and vayadi='$aygelen')") ;
		while($sonucum=mysqli_fetch_array($tresultvyil)){
