...
if($yilgelen==""){
$resultvyil = @mysql_query("select ilceidi as iii,vocadi as vvv,v176 as v176,sum(v1) as v1,sum(v3) as v3, 
...
sum(v166) as v166,sum(v167) as v167,sum(v168) as v168,sum(v169) as v169,sum(v170) as v170,sum(v171) as v171,sum(v172) as v172,v173 as v173,v174 as v174,v175 as v175,v176 as v176,v177 as v177,v178 as v178
...
sum(v148) as v148,sum(v149) as v149,sum(v150) as v150,sum(v151) as v151,sum(v152) as v152,sum(v153) as v153,sum(v154) as v154,sum(v155) as v155,sum(v156) as v156,sum(v157) as v157,sum(v158) as v158,sum(v159) as v159,sum(v160) as v160,sum(v161) as v161,sum(v162) as v162,sum(v163) as v163,sum(v164) as v164,sum(v165) as v165,
sum(v166) as v166,sum(v167) as v167,sum(v168) as v168,sum(v169) as v169,sum(v170) as v170,sum(v171) as v171,sum(v172) as v172,v173 as v173,v174 as v174,v175 as v175,v176 as v176,v177 as v177,v178 as v178
from veri where ilidi='$ilgelen' and vyiladi='$yilgelen' and (vayadi between '$aygelenx' and '$aygeleny') group by ilceidi order by ilceidi asc");
//$yer=$ilinadi;
...
sum(v148) as v148,sum(v149) as v149,sum(v150) as v150,sum(v151) as v151,sum(v152) as v152,sum(v153) as v153,sum(v154) as v154,sum(v155) as v155,sum(v156) as v156,sum(v157) as v157,sum(v158) as v158,sum(v159) as v159,sum(v160) as v160,sum(v161) as v161,sum(v162) as v162,sum(v163) as v163,sum(v164) as v164,sum(v165) as v165,
sum(v166) as v166,sum(v167) as v167,sum(v168) as v168,sum(v169) as v169,sum(v170) as v170,sum(v171) as v171,sum(v172) as v172,v173 as v173,v174 as v174,v175 as v175,v176 as v176,v177 as v177,v178 as v178
from veri where ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi='$yilgelen' and (vayadi between '$aygelenx' and '$aygeleny') group by vocadi order by vocadi asc") ;
...
sum(v148) as v148,sum(v149) as v149,sum(v150) as v150,sum(v151) as v151,sum(v152) as v152,sum(v153) as v153,sum(v154) as v154,sum(v155) as v155,sum(v156) as v156,sum(v157) as v157,sum(v158) as v158,sum(v159) as v159,sum(v160) as v160,sum(v161) as v161,sum(v162) as v162,sum(v163) as v163,sum(v164) as v164,sum(v165) as v165,
sum(v166) as v166,sum(v167) as v167,sum(v168) as v168,sum(v169) as v169,sum(v170) as v170,sum(v171) as v171,sum(v172) as v172,v173 as v173,v174 as v174,v175 as v175,v176 as v176,v177 as v177,v178 as v178
from veri where ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and (vayadi between '$aygelenx' and '$aygeleny') group by vocadi order by vocadi asc") ;
//$yer=$ocgelen;
...
if($secim=='ilsec' and substr($socadi,3,1)=='.'){
$socadi=trsuz(substr(trim($socadi),0,2));
$verim176=$ilceninadi;

}elseif($secim=='ilcesec' and substr($socadi,3,1)=='.'){
...
}elseif($secim=='aheksec' and substr($socadi,3,1)=='.'){
...
if($secim=="ilsec" and $ilcegelen==trsuz("İlçe Seçiniz")){
$top=trsuz('İLÇE TOPLAMI');
$kurumad=$ilceninadi;
$kurum=$ilceninadi.' '.$ilcetop;
...
}elseif($secim=="ilcesec" and $ocgelen==trsuz("Aile Hekimini Seçiniz")){
$kurumad=$ilceninadi;
$kurum=$socadi;
$kurumt=$ilceninadi.' '.$ilcetop;
$top=$socadi;

}elseif($secim=="aheksec" and $ilcegelen!=trsuz("İlçe Seçiniz") and $ocgelen!=trsuz("Aile Hekimini Seçiniz")){
$top=$ocgelen;
$kurum=$socadi;
...
->setCellValue('B3', mb_convert_encoding ($kurum, "UTF-8", "ISO-8859-9" ))
->setCellValue('B4', mb_convert_encoding ($yildonem, "UTF-8", "ISO-8859-9" ))
...
sum(v148) as v148,sum(v149) as v149,sum(v150) as v150,sum(v151) as v151,sum(v152) as v152,sum(v153) as v153,sum(v154) as v154,sum(v155) as v155,sum(v156) as v156,sum(v157) as v157,sum(v158) as v158,sum(v159) as v159,sum(v160) as v160,sum(v161) as v161,sum(v162) as v162,sum(v163) as v163,sum(v164) as v164,sum(v165) as v165,
sum(v166) as v166,sum(v167) as v167,sum(v168) as v168,sum(v169) as v169,sum(v170) as v170,sum(v171) as v171,sum(v172) as v172
from veri where ilidi='$ilgelen' and vyiladi='$yilgelen' and (vayadi between '$aygelenx' and '$aygeleny')") ;
...
sum(v148) as v148,sum(v149) as v149,sum(v150) as v150,sum(v151) as v151,sum(v152) as v152,sum(v153) as v153,sum(v154) as v154,sum(v155) as v155,sum(v156) as v156,sum(v157) as v157,sum(v158) as v158,sum(v159) as v159,sum(v160) as v160,sum(v161) as v161,sum(v162) as v162,sum(v163) as v163,sum(v164) as v164,sum(v165) as v165,
sum(v166) as v166,sum(v167) as v167,sum(v168) as v168,sum(v169) as v169,sum(v170) as v170,sum(v171) as v171,sum(v172) as v172
from veri where ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi='$yilgelen' and (vayadi between '$aygelenx' and '$aygeleny')") ;
...
sum(v148) as v148,sum(v149) as v149,sum(v150) as v150,sum(v151) as v151,sum(v152) as v152,sum(v153) as v153,sum(v154) as v154,sum(v155) as v155,sum(v156) as v156,sum(v157) as v157,sum(v158) as v158,sum(v159) as v159,sum(v160) as v160,sum(v161) as v161,sum(v162) as v162,sum(v163) as v163,sum(v164) as v164,sum(v165) as v165,
sum(v166) as v166,sum(v167) as v167,sum(v168) as v168,sum(v169) as v169,sum(v170) as v170,sum(v171) as v171,sum(v172) as v172
from veri where ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and (vayadi between '$aygelenx' and '$aygeleny')") ;
...
$top=$ilceninadi.' '.trsuz('İLÇE TOPLAMI');
...
$tresultvyil = @mysql_query("select v173 as v173,v174 as v174,v176 as v176,v177 as v177 from veri where ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen' and (vayadi between '$aygelenx' and '$aygeleny')") ;
while($sonucum=mysql_fetch_array($tresultvyil)){
...
$objPHPExcel->setActiveSheetIndex()->getStyle("E11:J11")->getFont()->setName('Arial')->setSize(8);
...
$objPHPExcel->setActiveSheetIndex()->getStyle("A15")->getFont()->setName('Arial')->setSize(8);
$objPHPExcel->setActiveSheetIndex()->getStyle("A17")->getFont()->setName('Arial')->setSize(8);
$objPHPExcel->setActiveSheetIndex()->getStyle("A19")->getFont()->setName('Arial')->setSize(8);
$objPHPExcel->setActiveSheetIndex()->getStyle("C17")->getFont()->setName('Arial')->setSize(9);
...
$objPHPExcel->setActiveSheetIndex()->getStyle("E24")->getFont()->setName('Arial')->setSize(9);
$objPHPExcel->setActiveSheetIndex()->getStyle("I24")->getFont()->setName('Arial')->setSize(9);
...
->setCellValue('B2', mb_convert_encoding ($ililce, "UTF-8", "ISO-8859-9" ))
->setCellValue('B3', mb_convert_encoding ($top, "UTF-8", "ISO-8859-9" ))
->setCellValue('B4', mb_convert_encoding ($yildonem, "UTF-8", "ISO-8859-9" ))
...
//DÜZENLEYEN-ONAYLAYAN			 
			->setCellValue('F23', mb_convert_encoding ($tverim173, "UTF-8", "ISO-8859-9" ))
			 
			->setCellValue('F24', mb_convert_encoding ($tverim174, "UTF-8", "ISO-8859-9" ))
			 
			->setCellValue('J23', mb_convert_encoding ($tverim176, "UTF-8", "ISO-8859-9" ))		 

			->setCellValue('J24', mb_convert_encoding ($tverim177, "UTF-8", "ISO-8859-9" ));	
