...
$resultvyil = @mysqli_query($dbh,"select tipi,ilid,ilceid,adi,adres,telefon,fax,email,web from $etf_db_name.adres where(ilid='$ilgelen' and tipi='$tipgelen') order by ilceid desc") ;
}
$rows = 4;
...
$objPHPExcel->getSheet(0)->getColumnDimension('A')->setWidth(14);
$objPHPExcel->getSheet(0)->getColumnDimension('B')->setWidth(40);
$objPHPExcel->getSheet(0)->getColumnDimension('C')->setWidth(40);
$objPHPExcel->getSheet(0)->getColumnDimension('D')->setWidth(14);
$objPHPExcel->getSheet(0)->getColumnDimension('E')->setWidth(14);
$objPHPExcel->getSheet(0)->getColumnDimension('F')->setWidth(26);
$objPHPExcel->getSheet(0)->getColumnDimension('G')->setWidth(26);
...
//DBT            
            ->setCellValue('A'.$rows, $ilceninadi)
...
header('Content-Disposition: attachment;filename="İl_Adres_Tipi.xls"');
