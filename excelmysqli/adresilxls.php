...
$objPHPExcel->getSheet(0)->setCellValue('B3','İLÇE:');
$objPHPExcel->getSheet(0)->setCellValue('C3','KURUM ADI:');
$objPHPExcel->getSheet(0)->setCellValue('D3','KURUM ADRESİ:');
$objPHPExcel->getSheet(0)->setCellValue('E3','TELEFON:');
$objPHPExcel->getSheet(0)->setCellValue('F3','FAKS:');
$objPHPExcel->getSheet(0)->setCellValue('G3','EMAİL ADRESİ:');
$objPHPExcel->getSheet(0)->setCellValue('H3','WEB ADRESİ:');
...
header('Content-Disposition: attachment;filename="İl_Adres.xls"');
