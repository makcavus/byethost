...
sum(v59) as v59,
sum(v60) as v60
from yg where(ilidi='$ilgelen' and vyiladi='$yilgelen' and ilceidi='$ilcegelen') group by vocadi order by vocadi desc") ;
...
$objPHPExcel->getSheet(1)->setTitle(trsuz($socadi));
...
sum(v171) as v171,
sum(v172) as v172
from yg where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vyiladi='$yilgelen') order by vocadi asc") ;
...
$objPHPExcel->getActiveSheet()->setTitle($toplamilce);
...
header('Content-Disposition: attachment;filename="Nüfus_Verileri_İlce.xls"');
