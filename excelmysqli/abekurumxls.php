...
v177 as v177,
v178 as v178
from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen') group by vocadi") ;

}else{
$resultvyil = @mysql_query("select vocadi as vvv,vayadi as vayadi,
v1 as v1,
sum(v2) as v2, 
v3 as v3,
sum(v4) as v4, 
...
v177 as v177,
v178 as v178
from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen') group by vayadi order by vayadi desc") or die (mysql_error()) ;
...
$aygelentarih=substr($ayadi,0,10); 
$aygelentarihgun=substr($aygelentarih,8,2);
$aygelentarihay=substr($aygelentarih,5,2);
$aygelentarihyil=substr($aygelentarih,0,4);
$ay=$aygelentarihgun.'.'.$aygelentarihay.'.'.$aygelentarihyil; 
...
->setCellValue('B3', mb_convert_encoding ($socadi, "UTF-8", "ISO-8859-9" ))
->setCellValue('B4', $ay)
//Vaka Sayıları
...
$objPHPExcel->getSheet(1)->setTitle(mb_convert_encoding ($ay, "UTF-8", "ISO-8859-9" ));
...
if($yilgelen==""){
$tresultvyil = @mysql_query("select  vocadi as vvv,
sum(v1) as v1,
sum(v2) as v2, 
sum(v3) as v3,
sum(v4) as v4, 
...
v177 as v177,
v178 as v178
from veri where(ilidi='$ilgelen' and ilceidi='$ilcegelen' and vocadi='$ocgelen' and vyiladi='$yilgelen') group by vocadi") or die (mysql_error()) ;
}
...
$tverim175=$sonucum['v175'];
$tverim176=$sonucum['v176'];
$tverim177=$sonucum['v177'];
$tverim178=$sonucum['v178'];
...
->setCellValue('B2', mb_convert_encoding ($ililce, "UTF-8", "ISO-8859-9" ))
->setCellValue('B3', mb_convert_encoding ($hangi, "UTF-8", "ISO-8859-9" ))
->setCellValue('B4', mb_convert_encoding ($yili, "UTF-8", "ISO-8859-9" ))

//->setCellValue('K3', mb_convert_encoding ($hangi, "UTF-8", "ISO-8859-9" ))
//Vaka Sayıları
...
$objPHPExcel->getActiveSheet(0)->setTitle(mb_convert_encoding ($tsocadi, "UTF-8", "ISO-8859-9" ));
