...
function getXMLHTTP() { //fuction to return the xml http object
 ...
 function topla(){ 
	 ...
	 if(isNaN(v4) || isNaN(v5)){ alert("her iki alanada sayi girmelisiniz!"); return false;} 
	 if (IS_GECKO) {  
			         XHRO = new XMLHttpRequest();
					     } else if(IS_IE) { 
						         XHRO = new ActiveXObject("Microsoft.XMLHTTP"); 
								    }else{ alert("browseriniz XMLHttpRequest y�ntemini desteklemiyor!"); return false; } 
   XHRO.open("GET","topla.php?v4="+v4+"&v5="+v5,true);
   XHRO.onreadystatechange = function(){ 
       if(XHRO.readyState == 4){
     if(XHRO.status == 200){  
	      document.getElementById("sonuc").value = XHRO.responseText;
     }else{  
 ...
 function topla1(){ 
		...
		var v11 = parseInt(document.getElementById("v11").value);
	    		   if(isNaN(v7) || isNaN(v8)|| isNaN(v9)|| isNaN(v10)|| isNaN(v11)){ alert("her iki alanada sayi girmelisiniz!"); return false;} 
		      if (IS_GECKO) {  
			         XHRO = new XMLHttpRequest();
					     } else if(IS_IE) { 
						         XHRO = new ActiveXObject("Microsoft.XMLHTTP"); 
  ...
  function topla2(){ 
		...
		var v44 = parseInt(document.getElementById("v44").value);
	    		   if(isNaN(v24) || isNaN(v26)|| isNaN(v28)|| isNaN(v30)|| isNaN(v32) || isNaN(v34)|| isNaN(v36)|| isNaN(v38)|| isNaN(v40)|| isNaN(v42)|| isNaN(v44)){ alert("her iki alanada sayi girmelisiniz!"); return false;} 
		      if (IS_GECKO) {  
			         XHRO = new XMLHttpRequest();
					     } else if(IS_IE) { 
						         XHRO = new ActiveXObject("Microsoft.XMLHTTP"); 
 ...
 function topla3(){ 
		...
		var v45 = parseInt(document.getElementById("v45").value);
	    		   if(isNaN(v25) || isNaN(v27)|| isNaN(v29)|| isNaN(v31)|| isNaN(v33) || isNaN(v35)|| isNaN(v37)|| isNaN(v39)|| isNaN(v41)|| isNaN(v43)|| isNaN(v45)){ alert("her iki alanada sayi girmelisiniz!"); return false;} 
		      if (IS_GECKO) {  
			         XHRO = new XMLHttpRequest();
					     } else if(IS_IE) { 
						         XHRO = new ActiveXObject("Microsoft.XMLHTTP"); 
  ...
  function topla4(){ 
		...
		var v57 = parseInt(document.getElementById("v57").value);
	    		   if(isNaN(v46) || isNaN(v47)|| isNaN(v48)|| isNaN(v49)|| isNaN(v50) || isNaN(v51)|| isNaN(v52)|| isNaN(v53)|| isNaN(v54)|| isNaN(v55)|| isNaN(v56)|| isNaN(v57)){ alert("her iki alanada sayi girmelisiniz!"); return false;} 
		      if (IS_GECKO) {  
			         XHRO = new XMLHttpRequest();
					     } else if(IS_IE) { 
						         XHRO = new ActiveXObject("Microsoft.XMLHTTP"); 
  ...
  function topla5(){ 
		...
		var v69 = parseInt(document.getElementById("v69").value);
	    		   if(isNaN(v58) || isNaN(v59)|| isNaN(v60)|| isNaN(v61)|| isNaN(v62) || isNaN(v63)|| isNaN(v64)|| isNaN(v65)|| isNaN(v66)|| isNaN(v67)|| isNaN(v68)|| isNaN(v69)){ alert("her iki alanada sayi girmelisiniz!"); return false;} 
		      if (IS_GECKO) {  
			         XHRO = new XMLHttpRequest();
					     } else if(IS_IE) { 
						         XHRO = new ActiveXObject("Microsoft.XMLHTTP"); 
  ...
  function topla6(){ 
		...
		var v81 = parseInt(document.getElementById("v81").value);
	    		   if(isNaN(v70) || isNaN(v71)|| isNaN(v72)|| isNaN(v73)|| isNaN(v74) || isNaN(v75)|| isNaN(v76)|| isNaN(v77)|| isNaN(v78)|| isNaN(v79)|| isNaN(v80)|| isNaN(v81)){ alert("her iki alanada sayi girmelisiniz!"); return false;} 
		      if (IS_GECKO) {  
			         XHRO = new XMLHttpRequest();
					     } else if(IS_IE) { 
						         XHRO = new ActiveXObject("Microsoft.XMLHTTP"); 
  ...
  function topla7(){ 
		...
		var v93 = parseInt(document.getElementById("v93").value);
	    		   if(isNaN(v82) || isNaN(v83)|| isNaN(v84)|| isNaN(v85)|| isNaN(v86) || isNaN(v87)|| isNaN(v88)|| isNaN(v89)|| isNaN(v90)|| isNaN(v91)|| isNaN(v92)|| isNaN(v93)){ alert("her iki alanada sayi girmelisiniz!"); return false;} 
		      if (IS_GECKO) {  
			         XHRO = new XMLHttpRequest();
					     } else if(IS_IE) { 
						         XHRO = new ActiveXObject("Microsoft.XMLHTTP"); 
  ...
  function topla8(){ 
		...
		var v105 = parseInt(document.getElementById("v105").value);
	    		   if(isNaN(v94) || isNaN(v95)|| isNaN(v96)|| isNaN(v97)|| isNaN(v98) || isNaN(v99)|| isNaN(v100)|| isNaN(v101)|| isNaN(v102)|| isNaN(v103)|| isNaN(v104)|| isNaN(v105)){ alert("her iki alanada sayi girmelisiniz!"); return false;} 
		      if (IS_GECKO) {  
			         XHRO = new XMLHttpRequest();
					     } else if(IS_IE) { 
						         XHRO = new ActiveXObject("Microsoft.XMLHTTP"); 
  ...
  function topla9(){ 
		...
		var v117 = parseInt(document.getElementById("v117").value);
	    		   if(isNaN(v106) || isNaN(v107)|| isNaN(v108)|| isNaN(v109)|| isNaN(v110) || isNaN(v111)|| isNaN(v112)|| isNaN(v113)|| isNaN(v114)|| isNaN(v115)|| isNaN(v116)|| isNaN(v117)){ alert("her iki alanada sayi girmelisiniz!"); return false;} 
		      if (IS_GECKO) {  
			         XHRO = new XMLHttpRequest();
					     } else if(IS_IE) { 
						         XHRO = new ActiveXObject("Microsoft.XMLHTTP"); 
...
$('div#adressonuc').html('Adres Bulunuyor...');
$.ajax({
type: 'GET',
url: noCache('adresler.php'),
data: $('form').serialize(),
success: function(ajaxCevap) {
$('div#adressonuc').html(ajaxCevap);
}
});
return false;
}
...
return false;
 ...
 //Kurum Tipine göre Adresi Alma
$(document).ready(function(){
$(':submit').click( ilcetoplamal );
});
function adresgittip()
{

$('div#adressonuc').html('Adres Bulunuyor...');
$.ajax({
type: 'GET',
url: noCache('adreslertip.php'),
data: $('form').serialize(),
success: function(ajaxCevap) {
$('div#adressonuc').html(ajaxCevap);
}
...
function kontrolharita()
{

$('div#sonucharita').html('Adres Bulunuyor...');
$.ajax({
type: 'GET',
url: noCache('haritail.php'),
data: $('form').serialize(),
success: function(ajaxCevap) {
$('div#sonucharita').html(ajaxCevap);
}
});
return false;
}
//İleti Yazma...................................................................................................................
$(document).ready(function(){
$(':submit').click( sonuciletiyaz);
});
function kayitiletiyaz()
{
$('div#sonuciletiyaz').html('Kayit ekleniyor');

$.ajax({
type: 'GET',
url: noCache('BizeUlasinKayit.php'),
data: $('form').serialize(),
success: function(ajaxCevap) {
$('div#sonuciletiyaz').html(ajaxCevap);
}
});
return false;
} 

//Yazılan İletiyi Düzenleme...................................................................................................................
$(document).ready(function(){
...
//Yazılan İletiyi Silme...................................................................................................................................................
function iletisilonay(viltiid,komut) // islem  fonksiyomuzda id ve komut isimli iki degisken kullanacagiz.id degiskeni ile verileri id degerini tasimak iin, komut degiskenini ise gncelleme iin kullanicagiz.
{
