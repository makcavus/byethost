...
function esitmibasvuru(){
	...
	if(v1<v3+v4+v5+v6+v14+v15+v16){ alert("Basvuran sayisi yontem verilen kisi sayisina esit veya fazla olmalidir!"); return false;}
	//else if(v3+v4+v5+v6+v14+v15+v16==0 && v1>0) { alert("Yontem dagitilmamis");return false;}
}
...
function esitmi42(){
	...
	if(v13>v4+v6){ alert("42.gune kadar AP yontemi baslayan sayisi Yeni Kondom ve RIA baslayan kisi sayisindan fazla olamaz!"); return false;}
	//else if(v4+v6==0) { alert("Hap dagitilmamis");return false;}
}
...
//Excel
function excel(ilidi,ilceidi,vocadi,vyiladi,vayadi,komut) // islem  fonksiyomuzda id ve komut isimli iki degisken kullanacagiz.id degiskeni ile verileri id degerini tasimak iin, komut degiskenini ise gncelleme iin kullanicagiz.

{

	$('div#sonuc').html('<br><img src="./images/excel.png">');
	...
	$.ajax({
		...
		url :noCache('engel.htm'),//islem yapilacak dosyayi belirtiyoruz.fonksiyonumuzdan gelen degiskenleri islem.php sayfasina get methodu ile gnderiyoruz.
...
//PDF
function pdf(ilidi,ilceidi,vocadi,vyiladi,vayadi,komut) // islem  fonksiyomuzda id ve komut isimli iki degisken kullanacagiz.id degiskeni ile verileri id degerini tasimak iin, komut degiskenini ise gncelleme iin kullanicagiz.

{

	$('div#sonuc').html('<br><img src="../images/pdf.png">');
