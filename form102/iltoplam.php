...
if($yilgelen==""){
$resultvyil = @mysqli_query($dbh102,"select * from veri where(ilidi='$ilgelen')") ;
}elseif($ilgelen>0 and $yilgelen>0){
  $resultvyil = @mysqli_query($dbh102,"select * from veri where(ilidi='$ilgelen' and vyiladi='$yilgelen')") ;
}
