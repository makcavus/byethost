...
'$_GET[v11]','$_GET[v12]','$_GET[v13]','$_GET[v14]','$_GET[v15]','$_GET[v16]','$_GET[v17]','$_GET[v18]','$_GET[v19]','$_GET[v20]','$_GET[v21]','$_GET[v22]','$_GET[v23]','$_GET[v24]',
...
'$ad','$unv','$dtarih','$drad','$drunv','$otarih')";
...
echo '<div class="alert-light"><button type="button" class="btn btn-danger btn-sm mt-3 mb-2" data-dismiss="modal" onclick="kontrol();">Kayıt Eklenemedi... <i class="fa fa-reply-all fa-lg"></i> Geri</button></div>';
	...
	echo'<meta http-equiv=refresh content="10; url=http://'.$siteadresi.'/site-bs/form102/index.php" /><a href="http://'.$siteadresi.'/site-bs/form102/index.php" _fcksavedurl="http://'.$siteadresi.'/site-bs/form102/index.php">Oturum Sonlandırıldı Tekrar Giriş Yapınız....</a>';

 }
}else{ echo '<label><font style="color:Red">Oturum Sonlandırıldı Tekrar Giriş Yapınız....</font></label><meta http-equiv=refresh content="10; url=http://'.$siteadresi.'/site-bs/form102/index.php" /><a href="http://'.$siteadresi.'/site-bs/form102/index.php" _fcksavedurl="http://'.$siteadresi.'/site-bs/form102/index.php"></a>';
echo'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
?>
<?php
