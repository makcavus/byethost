...
if($formad==NULL or $aheilcead==NULL or $aseilcead==NULL){
    ...
    echo'<meta http-equiv=refresh content="3; url=http://'.$siteadresi.'/byethost/form013/form_tanzim.php" />
    <a class="btn btn-primary btn-sm mt-1 mb-1" href="http://'.$siteadresi.'/byethost/form013/form_tanzim.php" _fcksavedurl="http://'.$siteadresi.'/byethost/form013/form_tanzim.php">
