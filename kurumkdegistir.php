...
//if($say<1){
$kayit="UPDATE ocak SET  socad='$kurumgelen',asmadi='$asmgelenvt',dradi='$drgelenvt',aseadi='$asegelenvt',aseunvan='$aseungelenvt' where(ilinad='$ilseckrgelen' and ilce='$ilceseckrgelen' and socad='$degkurumgelenvt')";
//}
...
echo '<th>Durum</th>';
echo '</tr>';
echo '<th class="bg-light">'.$degkurumgelen.' '.$oncekikurum.' '.$kurumgelen.' '.$sonraki.' <a href="ilekle.php" onsubmit="javascript:reloadPage(this)" class="btn btn-success btn-sm"><i class="fa fa-reply-all fa-lg"></i> Geri Dön</a></th></thead></table></div>';
}else{
echo '<div class="col-md-12 bg-warning text-dark mt-1" align="center">';
echo '<table class="table table-striped table-primary table-sm table-responsive-lg">';
echo '<thead align="center">';
...
echo '<th class="bg-light">Kurum Değiştirelemedi...<a href="ilekle.php"  onsubmit="javascript:reloadPage(this)" class="btn btn-success btn-sm"><i class="fa fa-reply-all fa-lg"></i> Geri Dön</a></th></thead></table>';
echo '</div>';
echo mysql_error();
 }
